...
val dress = dress2010015(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("死、忘るなかれ") {
            Act {
                /*
...
val _dress2010015 = PartialDressBlueprint(
  id = 2010015,
  name = "死神",
  baseRarity = 4,
  cost = 15,
