...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress4020011
...
val dress = dress4020011(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("ザフィーアベシュトラフング") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
    ...
    unitSkill = null /* シークフェルト音楽学院かつ、月属性の舞台少女のACTパワーアップ %opt1_value%%(MAX30%) クリティカル威力アップ %opt2_value%%(MAX30%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress4020011 = PartialDressBlueprint(
  id = 4020011,
  name = "シークフェルト音楽学院",
  baseRarity = 4,
  cost = 12,
