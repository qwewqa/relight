...
val dress = dress1050017(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("今宵、煌めきを、あなたに！") {
            Act {
                /*
                無属性攻撃(%value%) (完全固定値ダメージ、この攻撃でHPが0になった敵役は退場する)
                  target: 前から3体の敵役
                  hit_rate1: 100
                  values1: [5000, 5500, 6000, 6500, 7500]
                  times1: [2, 2, 2, 2, 2]
...
internal val _dress1050017 = PartialDressBlueprint(
  id = 1050017,
  name = "舞台少女",
  baseRarity = 4,
  cost = 15,
