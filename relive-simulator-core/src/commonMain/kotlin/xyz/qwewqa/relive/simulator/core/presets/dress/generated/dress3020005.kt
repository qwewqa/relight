...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress3020005
...
val dress = dress3020005(
    ...
    acts = listOf(
        ...
        ActType.Act3.blueprint("キラめきの援突") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
        ...
        ActType.ClimaxAct.blueprint("遅刻しちゃう！") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
...
internal val _dress3020005 = PartialDressBlueprint(
  id = 3020005,
  name = "白うさぎ",
  baseRarity = 3,
  cost = 9,
