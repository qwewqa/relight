...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1050022
...
val dress = dress1050022(
    ...
    acts = listOf(
        ...
        ActType.Act3.blueprint("騎士団長の導き") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
        ...
        ActType.ClimaxAct.blueprint("天道の理 Encore") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
...
internal val _dress1050022 = PartialDressBlueprint(
  id = 1050022,
  name = "悲劇の将 マリアヴェーラ",
  baseRarity = 4,
  cost = 14,
