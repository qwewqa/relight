        ...
        for ((id, effect) in valuesGenSkillFieldEffect) {
            +object : SkillFieldEffect {
                ...
                override val options = listOfNotNull(
                    getSkillFieldEffectOption(effect.option1_id, effect.option1_target_type, effect.option1_time, effect.option1_value),
                    getSkillFieldEffectOption(effect.option2_id, effect.option2_target_type, effect.option2_time, effect.option2_value),
                    getSkillFieldEffectOption(effect.option3_id, effect.option3_target_type, effect.option3_time, effect.option3_value),
                    getSkillFieldEffectOption(effect.option4_id, effect.option4_target_type, effect.option4_time, effect.option4_value),
                    getSkillFieldEffectOption(effect.option5_id, effect.option5_target_type, effect.option5_time, effect.option5_value),
                )
            }
        }
    }
