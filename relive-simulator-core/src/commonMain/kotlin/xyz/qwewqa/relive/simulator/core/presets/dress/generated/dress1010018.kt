...
val dress = dress1010018(
    name = "明智光秀",
    acts = listOf(
        ActType.Act1.blueprint("永遠の輝き") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 後ろから1番目の敵役
        ...
        ActType.ClimaxAct.blueprint("正義の業火") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
...
internal val _dress1010018 = PartialDressBlueprint(
  id = 1010018,
  name = "明智光秀",
  baseRarity = 4,
  cost = 13,
