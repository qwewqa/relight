...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1010002
...
val dress = dress1010002(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("太陽サンサンフルパワー") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
                  hit_rate1: 100
                  values1: [300, 315, 330, 345, 360]
                  times1: 3
                */
            }
        }
...
internal val _dress1010002 = PartialDressBlueprint(
  id = 1010002,
  name = "太陽の国の騎士",
  baseRarity = 3,
  cost = 9,
