...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1070013
...
val dress = dress1070013(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("輪舞") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
    ...
    unitSkill = null /* 聖翔音楽学園かつ、雪属性の舞台少女の最大HPアップ %opt1_value%%(MAX50%) 通常防御力アップ %opt2_value%%(MAX30%) 特殊防御力アップ %opt3_value%%(MAX30%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress1070013 = PartialDressBlueprint(
  id = 1070013,
  name = "聖翔音楽学園",
  baseRarity = 4,
  cost = 12,
