...
val tr45KomachiTamaoStrategy = FixedStrategy {
...
val tr45KomachiTamaoDiff4 =
    ActorLoadout(
        "TR45 Komachi Tamao Difficulty 4",
        Dress(
            name = "Komachi Tamao",
            character = Character.Tamao,
            attribute = Attribute.Dream,
...
val tr45KomachiTamaoDiff4Strategy = FixedStrategy {
  val boss = this.team.actors.values.first()
