...
object Buffs : ImplementationRegistry<BuffEffect>() {
    ...
    private inline fun <T> BuffData.makeMapModifierTimedBuffEffect(
        ...
        exclusive = exclusive,
        onStart = { value ->
            mapAccessor(self)[key] = (mapAccessor(self)[key] ?: 0) + value
        },
        onEnd = { value ->
            mapAccessor(self)[key] = (mapAccessor(self)[key] ?: 0) - value
        },
    ...
    private fun BuffData.attributeDamageDealtUpBuff(attribute: Attribute) = makeSimpleTimedBuffEffect(
        category = BuffCategory.Positive,
        onStart = { value ->
    ...
    private fun BuffData.attributeDamageDealtDownBuff(attribute: Attribute) = makeSimpleTimedBuffEffect(
        category = BuffCategory.Negative,
        onStart = { value ->
            self.attributeDamageDealtUp[attribute] -= value
        },
    ...
    val ActPowerUpBuff: TimedBuffEffect<Unit> = +buffData(1).makeModifierTimedBuffEffect(
        modifier = actPowerUp,
        category = BuffCategory.Positive,
        flipped = { ActPowerDownBuff }
    )

    val ActPowerDownBuff: TimedBuffEffect<Unit> = +buffData(2).makeModifierTimedBuffEffect(
        modifier = actPowerDown,
        category = BuffCategory.Negative,
        flipped = { ActPowerUpBuff }
    )

    val NormalDefenseUpBuff: TimedBuffEffect<Unit> = +buffData(3).makeModifierTimedBuffEffect(
        modifier = normalDefenseUp,
        category = BuffCategory.Positive,
        flipped = { NormalDefenseDownBuff }
    )

    val NormalDefenseDownBuff: TimedBuffEffect<Unit> = +buffData(4).makeModifierTimedBuffEffect(
        modifier = normalDefenseDown,
        category = BuffCategory.Negative,
        flipped = { NormalDefenseUpBuff }
    )

    val SpecialDefenseUpBuff: TimedBuffEffect<Unit> = +buffData(5).makeModifierTimedBuffEffect(
        modifier = specialDefenseUp,
        category = BuffCategory.Positive,
        flipped = { SpecialDefenseDownBuff }
    )

    val SpecialDefenseDownBuff: TimedBuffEffect<Unit> = +buffData(6).makeModifierTimedBuffEffect(
        modifier = specialDefenseDown,
        category = BuffCategory.Negative,
        flipped = { SpecialDefenseUpBuff }
    )

    val AgilityUpBuff: TimedBuffEffect<Unit> = +buffData(7).makeModifierTimedBuffEffect(
        modifier = agilityUp,
        category = BuffCategory.Positive,
        flipped = { AgilityDownBuff }
    )

    val AgilityDownBuff: TimedBuffEffect<Unit> = +buffData(8).makeModifierTimedBuffEffect(
        modifier = agilityDown,
        category = BuffCategory.Negative,
        flipped = { AgilityUpBuff }
    )

    val AccuracyUpBuff: TimedBuffEffect<Unit> = +buffData(9).makeModifierTimedBuffEffect(
        modifier = accuracyUp,
        category = BuffCategory.Positive,
        flipped = { AccuracyDownBuff }
    )

    val AccuracyDownBuff: TimedBuffEffect<Unit> = +buffData(10).makeModifierTimedBuffEffect(
        modifier = accuracyDown,
        category = BuffCategory.Negative,
        flipped = { AccuracyUpBuff }
    )

    val EvasionUpBuff: TimedBuffEffect<Unit> = +buffData(11).makeModifierTimedBuffEffect(
        modifier = evasionUp,
        category = BuffCategory.Positive,
        flipped = { EvasionDownBuff }
    )

    val EvasionDownBuff: TimedBuffEffect<Unit> = +buffData(12).makeModifierTimedBuffEffect(
        modifier = evasionDown,
        category = BuffCategory.Negative,
        flipped = { EvasionUpBuff }
    )

    val DexterityUpBuff: TimedBuffEffect<Unit> = +buffData(13).makeModifierTimedBuffEffect(
        modifier = buffDexterity,
        category = BuffCategory.Positive,
        flipped = { DexterityDownBuff }
    )

    val DexterityDownBuff: TimedBuffEffect<Unit> = +buffData(14).makeModifierTimedBuffEffect(
        modifier = debuffDexterity,
        category = BuffCategory.Negative,
        flipped = { DexterityUpBuff }
    )

    val CriticalUpBuff: TimedBuffEffect<Unit> = +buffData(15).makeModifierTimedBuffEffect(
        modifier = buffCritical,
        category = BuffCategory.Positive,
        flipped = { CriticalDownBuff }
    )

    val CriticalDownBuff: TimedBuffEffect<Unit> = +buffData(16).makeModifierTimedBuffEffect(
    ...
    val MaxHpUpBuff: TimedBuffEffect<Unit> = +buffData(17).makeModifierTimedBuffEffect(
        modifier = maxHpUp,
        category = BuffCategory.Positive,
    )

    val MaxHpDownBuff: TimedBuffEffect<Unit> = +buffData(18).makeModifierTimedBuffEffect(
        modifier = maxHpDown,
        category = BuffCategory.Negative,
    )

    val ContinuousNegativeEffectResistanceUpBuff = +buffData(19).makeModifierTimedBuffEffect(
        modifier = negativeEffectResistanceUp,
        category = BuffCategory.Positive,
    )

    val ContinuousNegativeEffectResistanceDownBuff = +buffData(20).makeModifierTimedBuffEffect(
        modifier = negativeEffectResistanceDown,
        category = BuffCategory.Negative,
    )

    val HpRegenBuff = +buffData(21).copy(name = "HP Regen").makeSimpleTimedBuffEffect(
        category = BuffCategory.Positive,
        onStart = { value ->
            if (value <= 100) {
    ...
    val FixedNormalDefenseBoostBuff = +buffData(30).makeModifierTimedBuffEffect(
        modifier = fixedNormalDefense,
        category = BuffCategory.Positive,
    )

    val FixedSpecialDefenseBoostBuff = +buffData(31).makeModifierTimedBuffEffect(
    ...
    val ClimaxDamageUpBuff: TimedBuffEffect<Unit> = +buffData(33).makeModifierTimedBuffEffect(
    ...
    val CriticalDamageReceivedDownBuff: TimedBuffEffect<Unit> = +buffData(34).makeModifierTimedBuffEffect(
        modifier = criticalDamageReceivedDown,
        category = BuffCategory.Positive,
    )

    val FixedActPowerBoostBuff = +buffData(35).makeModifierTimedBuffEffect(
    ...
    val CounterHealBuff = +buffData(38).makeTimedBuffEffect(
        category = BuffCategory.Positive,
        onStart = { value, _ ->
            if (value <= 100) {
    ...
    val AgainstFlowerDamageDealtUpBuff =
        buffData(39).copy(name = "Bonus Dmg vs. Flower").againstAttributeDamageDealtUpBuff(Attribute.Flower)
    val AgainstWindDamageDealtUpBuff =
        buffData(40).copy(name = "Bonus Dmg vs. Wind").againstAttributeDamageDealtUpBuff(Attribute.Wind)
    val AgainstSnowDamageDealtUpBuff =
        buffData(41).copy(name = "Bonus Dmg vs. Snow").againstAttributeDamageDealtUpBuff(Attribute.Snow)
    val AgainstMoonDamageDealtUpBuff =
        buffData(42).copy(name = "Bonus Dmg vs. Moon").againstAttributeDamageDealtUpBuff(Attribute.Moon)
    val AgainstSpaceDamageDealtUpBuff =
        buffData(43).copy(name = "Bonus Dmg vs. Space").againstAttributeDamageDealtUpBuff(Attribute.Space)
    val AgainstCloudDamageDealtUpBuff =
        buffData(44).copy(name = "Bonus Dmg vs. Cloud").againstAttributeDamageDealtUpBuff(Attribute.Cloud)
    val AgainstDreamDamageDealtUpBuff =
        buffData(45).copy(name = "Bonus Dmg vs. Dream").againstAttributeDamageDealtUpBuff(Attribute.Dream)
...
//    val ActionRestrictionResistanceUpBuffAuto = +buffData(73)
    ...
    val DamageDealtUpBuff: TimedBuffEffect<Unit> = +buffData(95).makeModifierTimedBuffEffect(
        modifier = damageDealtUp,
        category = BuffCategory.Positive,
        flipped = { DamageDealtDownBuff }
    )

    val DamageDealtDownBuff: TimedBuffEffect<Unit> = +buffData(96).makeModifierTimedBuffEffect(
        modifier = damageDealtDown,
        category = BuffCategory.Negative,
        flipped = { DamageDealtUpBuff }
    )

    val DamageReceivedUpBuff: TimedBuffEffect<Unit> = +buffData(97).makeModifierTimedBuffEffect(
        modifier = damageReceivedUp,
        category = BuffCategory.Negative,
        flipped = { DamageReceivedDownBuff }
    )

    val DamageReceivedDownBuff: TimedBuffEffect<Unit> = +buffData(98).makeModifierTimedBuffEffect(
        modifier = damageReceivedDown,
        category = BuffCategory.Positive,
        flipped = { DamageReceivedUpBuff }
    )

    val MarkBuff: TimedBuffEffect<Unit> = +buffData(99).makeIdempotentTimedBuffEffect(
        category = BuffCategory.Negative,
        exclusive = true,
    ...
    val FlippedMarkBuff: TimedBuffEffect<Unit> = +buffData(100).makeIdempotentTimedBuffEffect(
        category = BuffCategory.Positive,
        exclusive = true,
        flipped = { MarkBuff },
        onStart = {
    ...
    val AggroBuff = +buffData(101).makeTimedBuffEffect(
        category = BuffCategory.Negative,
        exclusive = true,
    ...
    val ApDownBuff: TimedBuffEffect<Unit> = +buffData(105).makeSimpleTimedBuffEffect(
        category = BuffCategory.Positive,
        flipped = { ApUpBuff },
    )

    val ApUpBuff: TimedBuffEffect<Unit> = +buffData(106).copy(name = "AP Up").makeSimpleTimedBuffEffect(
        category = BuffCategory.Negative,
        flipped = { ApDownBuff },
    )
    ...
    val AllEffectResistanceUpBuff = +buffData(117).makeTimedBuffEffect(
        category = BuffCategory.Positive,
        locked = true,
        onStart = { value, _ ->
            self.mod {
    ...
    val LockedConfusionResistanceUpBuff = +buffData(132).makeLockedVariantOf(ConfusionResistanceUpBuff)
...
//    val ContinuousDamageResistanceUpBuff = +buffData(144).makeSpecificResistanceUpBuff(ContinuousDamageBuff)

//    val StrongPoisonResistanceUpBuff = +buffData(145).makeSpecificResistanceUpBuff(StrongPoisonBuff)
//    val HeavyBurnResistanceUpBuff = +buffData(146).makeSpecificResistanceUpBuff(HeavyBurnBuff)
    ...
    val ClimaxDamageDownBuff: TimedBuffEffect<Unit> = +buffData(161).makeModifierTimedBuffEffect(
    ...
    val LockedLovesicknessResistanceUpBuff = +buffData(165).makeLockedVariantOf(LovesicknessResistanceUpBuff)
    ...
    val LockedElectricShockResistanceUpBuff = +buffData(172).makeLockedVariantOf(ElectricShockResistanceUpBuff)
    ...
    val ContinuousPositiveEffectResistanceUpBuff = +buffData(175).makeModifierTimedBuffEffect(
        modifier = positiveEffectResistanceUp,
        category = BuffCategory.Negative
    )
    ...
    val PositiveEffectResistanceUpBuff = +buffData(177).makeTimedBuffEffect(
        category = BuffCategory.Positive,
        locked = true,
        onStart = { value, _ ->
            self.mod {
    ...
    val LockedPositiveEffectResistanceUpBuff = +buffData(178).makeLockedVariantOf(PositiveEffectResistanceUpBuff)
    ...
    val FixedAgilityBoost = +buffData(183).makeModifierTimedBuffEffect(
        modifier = fixedAgility,
        category = BuffCategory.Positive,
    )

    val FixedMaxHpBoost = +buffData(184).makeModifierTimedBuffEffect(
        modifier = fixedMaxHp,
        category = BuffCategory.Positive,
    )
    ...
    val DamageToSeishoUpBuff = +buffData(186).makeMapModifierTimedBuffEffect(
        { it.againstSchoolDamageDealtUp },
        key = School.Seisho,
        category = BuffCategory.Positive,
    )

    val DamageToRinmeikanUpBuff = +buffData(187).makeMapModifierTimedBuffEffect(
        { it.againstSchoolDamageDealtUp },
        key = School.Rinmeikan,
        category = BuffCategory.Positive,
    )

    val DamageToFrontierUpBuff = +buffData(188).makeMapModifierTimedBuffEffect(
        { it.againstSchoolDamageDealtUp },
        key = School.Frontier,
        category = BuffCategory.Positive,
    )

    val DamageToSiegfeldUpBuff = +buffData(189).makeMapModifierTimedBuffEffect(
        { it.againstSchoolDamageDealtUp },
        key = School.Siegfeld,
        category = BuffCategory.Positive,
    )

    val DamageToSeiranUpBuff = +buffData(190).makeMapModifierTimedBuffEffect(
        { it.againstSchoolDamageDealtUp },
        key = School.Seiran,
        category = BuffCategory.Positive,
    )

    val DamageFromKarenUpBuff = +buffData(191).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Karen,
        category = BuffCategory.Negative,
    )

    val DamageFromHikariUpBuff = +buffData(192).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Hikari,
        category = BuffCategory.Negative,
    )

    val DamageFromMahiruUpBuff = +buffData(193).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Mahiru,
        category = BuffCategory.Negative,
    )

    val DamageFromClaudineUpBuff = +buffData(194).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Claudine,
        category = BuffCategory.Negative,
    )

    val DamageFromMayaUpBuff = +buffData(195).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Maya,
        category = BuffCategory.Negative,
    )

    val DamageFromJunnaUpBuff = +buffData(196).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Junna,
        category = BuffCategory.Negative,
    )

    val DamageFromNanaUpBuff = +buffData(197).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Nana,
        category = BuffCategory.Negative,
    )

    val DamageFromFutabaUpBuff = +buffData(198).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Futaba,
        category = BuffCategory.Negative,
    )

    val DamageFromKaorukoUpBuff = +buffData(199).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Kaoruko,
        category = BuffCategory.Negative,
    )

    val DamageFromTamaoUpBuff = +buffData(200).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Tamao,
        category = BuffCategory.Negative,
    )

    val DamageFromIchieUpBuff = +buffData(201).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Ichie,
        category = BuffCategory.Negative,
    )

    val DamageFromFumiUpBuff = +buffData(202).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Fumi,
        category = BuffCategory.Negative,
    )

    val DamageFromRuiUpBuff = +buffData(203).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Rui,
        category = BuffCategory.Negative,
    )

    val DamageFromYuyukoUpBuff = +buffData(204).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Yuyuko,
        category = BuffCategory.Negative,
    )

    val DamageFromAruruUpBuff = +buffData(205).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Aruru,
        category = BuffCategory.Negative,
    )

    val DamageFromMisoraUpBuff = +buffData(206).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Misora,
        category = BuffCategory.Negative,
    )

    val DamageFromLalafinUpBuff = +buffData(207).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Lalafin,
        category = BuffCategory.Negative,
    )

    val DamageFromTsukasaUpBuff = +buffData(208).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Tsukasa,
        category = BuffCategory.Negative,
    )

    val DamageFromShizuhaUpBuff = +buffData(209).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Shizuha,
        category = BuffCategory.Negative,
    )

    val DamageFromAkiraUpBuff = +buffData(210).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Akira,
        category = BuffCategory.Negative,
    )

    val DamageFromMichiruUpBuff = +buffData(211).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Michiru,
        category = BuffCategory.Negative,
    )

    val DamageFromMeiFanUpBuff = +buffData(212).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.MeiFan,
        category = BuffCategory.Negative,
    )

    val DamageFromShioriUpBuff = +buffData(213).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Shiori,
        category = BuffCategory.Negative,
    )

    val DamageFromYachiyoUpBuff = +buffData(214).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Yachiyo,
        category = BuffCategory.Negative,
    )

    val DamageFromKoharuUpBuff = +buffData(215).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Koharu,
        category = BuffCategory.Negative,
    )

    val DamageFromSuzuUpBuff = +buffData(216).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
        key = Character.Suzu,
        category = BuffCategory.Negative,
    )

    val DamageFromHisameUpBuff = +buffData(217).makeMapModifierTimedBuffEffect(
        { it.fromCharacterDamageReceivedUp },
    ...
    val PossessionBuff = +buffData(225).makeTimedBuffEffect(
    ...
    val ApUp2Buff: TimedBuffEffect<Unit> = +buffData(235).makeSimpleTimedBuffEffect(
        category = BuffCategory.Negative,
    )

    val LockedApUp2Buff: TimedBuffEffect<Unit> = +buffData(236).makeSimpleTimedBuffEffect(
        category = BuffCategory.Negative,
    )

    val ApDown2Buff: TimedBuffEffect<Unit> = +buffData(237).makeSimpleTimedBuffEffect(
        category = BuffCategory.Positive,
    )

    val LockedApDown2Buff: TimedBuffEffect<Unit> = +buffData(238).makeSimpleTimedBuffEffect(
        category = BuffCategory.Positive,
    )

    // TODO: handle stacking properly
    val CutinInitialCooldownReductionBuff = +buffData(239).makeTimedBuffEffect(
        category = BuffCategory.Positive,
        onStart = { value, _ ->
            self.cutinInitialCooldownReduction += value
        },
        onEnd = { value, _, _ ->
            self.cutinInitialCooldownReduction -= value
        },
    ...
    val CounterHealBuff2 = +buffData(240).makeModifierTimedBuffEffect(
...
//    val BulkheadBuff = +buffData(246).makeSimpleTimedBuffEffect(BuffCategory.Positive)
    ...
    val BlessingCountableDebuffReduction = buffData(250).makeCountableBuffEffect(BuffCategory.Positive)
    ...
    val HpRegenBuff2 = +buffData(268).copy(name = "HP Regen").makeSimpleTimedBuffEffect(
        category = BuffCategory.Positive,
        onStart = { value ->
            if (value <= 100) {
                self.mod { hpPercentRegen += value }
    ...
    val CountablePositiveEffectResistanceUpBuff = buffData(271).makeModifierTimedBuffEffect(
        modifier = positiveCountableEffectResistanceUp,
        category = BuffCategory.Negative,
    )

    val LockedCountablePositiveEffectResistanceUpBuff = buffData(272).makeLockedVariantOf(CountablePositiveEffectResistanceUpBuff)

    val LockedPerfectAimBuff = +buffData(273).makeLockedVariantOf(PerfectAimBuff)

    val StaminaActPowerUpBuff = buffData(274).makeModifierTimedBuffEffect(
    ...
    val BrillianceSap = buffData(277).makeModifierTimedBuffEffect(
        modifier = brillianceRegen,
        category = BuffCategory.Negative,
    )

    val EffectiveDamageDealtUpBuff2 = buffData(278).makeModifierTimedBuffEffect(
        modifier = effectiveDamageUp,
        category = BuffCategory.Positive,
    )

    val LockedBrillianceRegenBuff = +buffData(279).copy(name = "(Unremovable) Brilliance Regen").makeLockedVariantOf(BrillianceRegenBuff)

    val ReviveRegen = buffData(280).makeModifierTimedBuffEffect(
    ...
    val SealStageEffectResistanceUpBuff = buffData(282).makeSpecificResistanceUpBuff(SealStageEffectBuff)

    val LockedSealStageEffectResistanceUpBuff = buffData(283).makeLockedVariantOf(SealStageEffectResistanceUpBuff)

    val TurnDispelContinuousNegativeEffectsBuff = +buffData(284).makeSimpleTimedBuffEffect(BuffCategory.Positive)

    val LockedTurnDispelContinuousNegativeEffectsBuff = +buffData(285).makeLockedVariantOf(TurnDispelContinuousNegativeEffectsBuff)

    val TurnDispelCountableNegativeEffectsBuff = +buffData(286).makeSimpleTimedBuffEffect(BuffCategory.Positive)

    val LockedTurnDispelCountableNegativeEffectsBuff = +buffData(287).makeLockedVariantOf(TurnDispelCountableNegativeEffectsBuff)

    val TurnDispelContinuousPositiveEffectsBuff = +buffData(288).makeSimpleTimedBuffEffect(BuffCategory.Negative)

    val LockedTurnDispelContinuousPositiveEffectsBuff = +buffData(289).makeLockedVariantOf(TurnDispelContinuousPositiveEffectsBuff)

    val TurnDispelCountablePositiveEffectsBuff = +buffData(290).makeSimpleTimedBuffEffect(BuffCategory.Negative)

    val LockedTurnDispelCountablePositiveEffectsBuff = +buffData(291).makeLockedVariantOf(TurnDispelCountablePositiveEffectsBuff)
    ...
    val TurnReduceCountableNegativeEffectsBuff = +buffData(297).makeModifierTimedBuffEffect(
        modifier = turnReduceCountableNegativeEffects,
        category = BuffCategory.Positive,
    )

    val LockedTurnReduceCountableNegativeEffectsBuff = +buffData(298).makeLockedVariantOf(TurnReduceCountableNegativeEffectsBuff)
