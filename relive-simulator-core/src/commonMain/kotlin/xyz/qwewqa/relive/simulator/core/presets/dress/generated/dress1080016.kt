...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1080016
...
val dress = dress1080016(
    name = "舞台少女コレクション",
    acts = listOf(
        ActType.Act1.blueprint("華麗なポーズ") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 後ろから1番目の敵役
        ...
        ActType.Act2.blueprint("華麗なウォーキング") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 後ろから1番目の敵役
        ...
        ActType.Act3.blueprint("華麗なスマイル") {
            Act {
                /*
                キラめき回復(%value%)
                  target: 後ろから5体の味方
        ...
        ActType.ClimaxAct.blueprint("石動双葉のランウェイ") {
            Act {
                /*
                AP減少
                  target: 味方全体
...
internal val _dress1080016 = PartialDressBlueprint(
  id = 1080016,
  name = "舞台少女コレクション",
  baseRarity = 4,
  cost = 20,
