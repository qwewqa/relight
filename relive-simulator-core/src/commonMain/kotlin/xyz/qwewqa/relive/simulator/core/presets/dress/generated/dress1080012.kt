...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1080012
...
val dress = dress1080012(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("キラキラのパッション") {
            Act {
                /*
                %attr%属性攻撃(威力%value%) (ACTタイプ[特殊]の敵役に特攻)
                  target: 敵役全体
...
internal val _dress1080012 = PartialDressBlueprint(
  id = 1080012,
  name = "スクールアイドル",
  baseRarity = 4,
  cost = 12,
