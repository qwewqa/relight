...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress2010005
...
val dress = dress2010005(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("別離の玉手箱") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
...
internal val _dress2010005 = PartialDressBlueprint(
  id = 2010005,
  name = "乙姫",
  baseRarity = 4,
  cost = 12,
