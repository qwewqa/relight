...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1050015
...
val dress = dress1050015(
    ...
    unitSkill = null /* 風属性かつ、ACTタイプ[通常]の舞台少女のACTパワーアップ %opt1_value%%(MAX30%) クリティカル威力アップ %opt2_value%%(MAX30%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress1050015 = PartialDressBlueprint(
  id = 1050015,
  name = "聖翔音楽学園",
  baseRarity = 4,
  cost = 12,
