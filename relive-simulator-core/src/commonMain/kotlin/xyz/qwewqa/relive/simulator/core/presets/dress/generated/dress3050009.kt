...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress3050009
...
val dress = dress3050009(
    ...
    acts = listOf(
        ...
        ActType.Act3.blueprint("ヴィーナスの美") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
        ...
        ActType.ClimaxAct.blueprint("ラヴ・シャワー") {
            Act {
                /*
                %attr%属性攻撃(威力%value%) (混乱状態の敵役に特攻)
                  target: 敵役全体
                  hit_rate1: 100
...
val _dress3050009 = PartialDressBlueprint(
  id = 3050009,
  name = "ヴィーナス",
  baseRarity = 4,
  cost = 12,
