...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1060013
...
val dress = dress1060013(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("読書中はお静かに！") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
...
internal val _dress1060013 = PartialDressBlueprint(
  id = 1060013,
  name = "ジョー",
  baseRarity = 4,
  cost = 12,
