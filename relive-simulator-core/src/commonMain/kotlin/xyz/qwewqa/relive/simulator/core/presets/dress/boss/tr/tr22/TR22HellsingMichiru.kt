...
val tr22HellsingMichiru = ActorLoadout(
    "TR22 Hellsing Michiru",
    Dress(
        name = "TR22 Hellsing Michiru",
...
val tr22HellsingMichiruStrategy = FixedStrategy {
...
val tr22HellsingMichiruDiff4 = ActorLoadout(
    "TR22 Hellsing Michiru Difficulty 4",
    Dress(
        name = "TR22 Hellsing Michiru",
        character = Character.Michiru,
        attribute = Attribute.Dream,
...
val tr22HellsingMichiruDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
