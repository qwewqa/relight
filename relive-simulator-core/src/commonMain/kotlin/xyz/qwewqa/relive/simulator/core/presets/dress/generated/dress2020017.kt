...
val dress = dress2020017(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("聞かせて魅せます命の響！") {
            Act {
                /*
                継続プラス効果解除
                  target: 敵役全体
...
internal val _dress2020017 = PartialDressBlueprint(
  id = 2020017,
  name = "舞台少女",
  baseRarity = 4,
  cost = 15,
