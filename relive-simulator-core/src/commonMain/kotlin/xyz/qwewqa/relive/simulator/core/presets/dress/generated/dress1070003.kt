...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1070003
...
val dress = dress1070003(
    ...
    acts = listOf(
        ...
        ActType.Act3.blueprint("毒舞") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前グループの敵役
                  hit_rate1: 100
                  values1: [97, 102, 107, 112, 117]
                  times1: 2
                毒(%value%)
                  target: 前グループの敵役
                  hit_rate2: 100
                  values2: [60, 100, 180, 300, 470]
                  times2: [4, 4, 4, 4, 4]
                */
            }
        },
        ActType.ClimaxAct.blueprint("ファントムの涙") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
...
internal val _dress1070003 = PartialDressBlueprint(
  id = 1070003,
  name = "ファントム",
  baseRarity = 4,
  cost = 12,
