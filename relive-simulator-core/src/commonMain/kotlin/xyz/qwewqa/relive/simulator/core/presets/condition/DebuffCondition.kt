...
val ElectricShockOnlyCondition = NamedCondition("Electric Shock") { Buffs.ElectricShockBuff in it.buffs }

val LovesicknessOnlyCondition = NamedCondition("Lovesickness") { Buffs.LovesicknessBuff in it.buffs }
