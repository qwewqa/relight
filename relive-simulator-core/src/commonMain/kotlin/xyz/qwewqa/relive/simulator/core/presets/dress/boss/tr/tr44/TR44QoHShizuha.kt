...
val tr44QueenOfHeartsShizuha =
    ActorLoadout(
        "TR44 Queen of Hearts Shizuha",
        Dress(
...
val tr44QueenOfHeartsShizuhaStrategy = FixedStrategy {
...
val tr44QueenOfHeartsShizuhaDiff4 =
    ActorLoadout(
        "TR44 Queen of Hearts Shizuha Difficulty 4",
        Dress(
            name = "Queen of Hearts Shizuha",
            character = Character.Shizuha,
            attribute = Attribute.Wind,
...
val tr44QueenOfHeartsShizuhaDiff4Strategy = FixedStrategy {
  val boss = this.team.actors.values.first()
