...
val tr24HangedManRui = ActorLoadout(
    "TR24 Hanged Man Rui",
    Dress(
        name = "Hanged Man Rui",
...
val tr24HangedManRuiStrategy = FixedStrategy {
...
val tr24HangedManRuiDiff4 = ActorLoadout(
    "TR24 Hanged Man Rui Difficulty 4",
    Dress(
        name = "Hanged Man Rui",
        character = Character.Rui,
        attribute = Attribute.Space,
...
val tr24HangedManRuiDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
