...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1030009
...
val dress = dress1030009(
    ...
    acts = listOf(
        ...
        ActType.Act3.blueprint("ルネサンスの光") {
            Act {
                /*
                継続マイナス効果解除
                  target: 後ろから3体の味方
        ...
        ActType.ClimaxAct.blueprint("愛弟子の奮闘") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
    ...
    unitSkill = null /* 雪属性の舞台少女のACTパワーアップ %opt1_value%%(MAX5%) クリティカル威力アップ %opt2_value%%(MAX5%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress1030009 = PartialDressBlueprint(
  id = 1030009,
  name = "サライ",
  baseRarity = 3,
  cost = 9,
