...
class StageEffects : ImplementationRegistry<StageEffect>() {
    ...
    init {
        for ((id, effect) in valuesGenFieldEffect) {
            +StageEffect(
                ...
                buffs = listOfNotNull(
                    getStageEffectBuff(effect.buff_type1, effect.buff_type1_target_id, effect.buff_type1_value_list),
                    getStageEffectBuff(effect.buff_type2, effect.buff_type2_target_id, effect.buff_type2_value_list),
                    getStageEffectBuff(effect.buff_type3, effect.buff_type3_target_id, effect.buff_type3_value_list),
                    getStageEffectBuff(effect.buff_type4, effect.buff_type4_target_id, effect.buff_type4_value_list),
                    getStageEffectBuff(effect.buff_type5, effect.buff_type5_target_id, effect.buff_type5_value_list),
