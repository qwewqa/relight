...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1090010
...
val dress = dress1090010(
    name = "漂流者",
    acts = listOf(
        ActType.Act1.blueprint("快癒の斬撃") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
        ...
        ActType.Act3.blueprint("シールドステップ") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
                ...
                通常バリア(%value%)
                  target: 後ろから3体の味方
                  hit_rate3: 100
                  values3: [1000, 2000, 3000, 4000, 6000]
                  times3: [2, 2, 2, 2, 2]
                */
            }
        },
        ActType.ClimaxAct.blueprint("宿敵との対決") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
...
internal val _dress1090010 = PartialDressBlueprint(
  id = 1090010,
  name = "漂流者",
  baseRarity = 4,
  cost = 12,
