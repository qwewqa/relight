...
val dress = dress2030018(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("オルフェウスの調べ") {
            Act {
                /*
                継続プラス効果解除
                  target: 敵役全体
...
internal val _dress2030018 = PartialDressBlueprint(
  id = 2030018,
  name = "オルフェウス",
  baseRarity = 4,
  cost = 23,
