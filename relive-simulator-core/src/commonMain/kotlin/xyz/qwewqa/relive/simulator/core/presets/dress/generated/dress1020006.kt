...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1020006
        ...
        ActType.Act3.blueprint("堅守の歌") {
            Act {
                ...
                通常バリア(%value%)
                  target: 自身
                  hit_rate1: 100
                  values1: [260, 500, 920, 1520, 2320]
                  times1: [3, 3, 3, 3, 3]
                通常防御力アップ(%value%)
                  target: 自身
                  hit_rate2: 100
                  values2: [24, 26, 29, 31, 34]
                  times2: [3, 3, 3, 3, 3]
                */
            }
        },
        ActType.ClimaxAct.blueprint("マカロン・ドリーム") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
...
internal val _dress1020006 = PartialDressBlueprint(
  id = 1020006,
  name = "心を込めて手作り中",
  baseRarity = 3,
  cost = 9,
