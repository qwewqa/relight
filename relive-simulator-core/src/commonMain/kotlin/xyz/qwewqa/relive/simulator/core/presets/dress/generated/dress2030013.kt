...
val dress = dress2030013(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("狂気の愛") {
            Act {
                /*
...
internal val _dress2030013 = PartialDressBlueprint(
  id = 2030013,
  name = "ドン・ホセ",
  baseRarity = 4,
  cost = 20,
