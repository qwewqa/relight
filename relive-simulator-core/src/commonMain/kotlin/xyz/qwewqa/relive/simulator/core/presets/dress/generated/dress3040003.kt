...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress3040003
...
val dress = dress3040003(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("パンプキントリック") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前グループの敵役
...
internal val _dress3040003 = PartialDressBlueprint(
  id = 3040003,
  name = "奔放なクモの魔女",
  baseRarity = 3,
  cost = 9,
