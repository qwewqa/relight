...
val tr38MusketeerKaren =
    ActorLoadout(
        "TR38 Musketeer Karen",
        Dress(
...
val tr38MusketeerKarenStrategy = FixedStrategy {
...
val tr38MusketeerKarenDiff4 =
    ActorLoadout(
        "TR38 Musketeer Karen Difficulty 4",
        Dress(
            name = "Musketeer Karen",
            character = Character.Karen,
            attribute = Attribute.Dream,
...
val tr38MusketeerKarenDiff4Strategy = FixedStrategy {
  val boss = this.team.actors.values.first()
