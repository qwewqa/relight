...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1060005
...
val dress = dress1060005(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("シャーウッドに潜む影") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
...
internal val _dress1060005 = PartialDressBlueprint(
  id = 1060005,
  name = "ロビンフッド",
  baseRarity = 4,
  cost = 12,
