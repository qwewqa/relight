...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1020005
...
val dress = dress1020005(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("八咫鏡　天照舞") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
...
internal val _dress1020005 = PartialDressBlueprint(
  id = 1020005,
  name = "アマテラス",
  baseRarity = 4,
  cost = 12,
