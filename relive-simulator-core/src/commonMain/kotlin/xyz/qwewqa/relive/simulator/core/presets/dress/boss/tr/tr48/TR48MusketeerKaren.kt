...
val tr48MusketeerKaren =
    ActorLoadout(
        "TR48 Musketeer Karen",
        Dress(
...
val tr48MusketeerKarenStrategy = FixedStrategy {
...
val tr48MusketeerKarenDiff4 =
    ActorLoadout(
        "TR48 Musketeer Karen Difficulty 4",
        Dress(
            name = "Musketeer Karen",
            character = Character.Karen,
            attribute = Attribute.Dream,
...
val tr48MusketeerKarenDiff4Strategy = FixedStrategy {
  val boss = this.team.actors.values.first()
