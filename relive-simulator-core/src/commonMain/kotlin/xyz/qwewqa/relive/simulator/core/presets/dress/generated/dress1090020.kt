...
val dress = dress1090020(
    name = "舞台少女コレクション",
    acts = listOf(
        ActType.Act1.blueprint("優雅なポーズ") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 後ろから1番目の敵役
        ...
        ActType.Act2.blueprint("優雅なウォーキング") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 後ろから1番目の敵役
        ...
        ActType.Act3.blueprint("優雅なスマイル") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 後ろから1番目の敵役
        ...
        ActType.ClimaxAct.blueprint("花柳香子のランウェイ") {
            Act {
                /*
...
internal val _dress1090020 = PartialDressBlueprint(
  id = 1090020,
  name = "舞台少女コレクション",
  baseRarity = 4,
  cost = 20,
