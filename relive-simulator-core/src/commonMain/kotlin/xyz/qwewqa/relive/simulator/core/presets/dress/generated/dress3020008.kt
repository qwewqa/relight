...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress3020008
...
val dress = dress3020008(
        ...
        ActType.Act3.blueprint("毒咲花") {
            Act {
                ...
                毒(%value%)
                  target: 前から3体の敵役
                  hit_rate2: 50
                  values2: [500, 700, 900, 1200, 1500]
                  times2: [3, 3, 3, 3, 3]
                */
            }
        },
        ActType.ClimaxAct.blueprint("ワイルドバンチ") {
            Act {
                /*
    ...
    unitSkill = null /* フロンティア芸術学校かつ、雪属性の舞台少女の最大HPアップ %opt1_value%%(MAX50%) 通常防御力アップ %opt2_value%%(MAX30%) 特殊防御力アップ %opt3_value%%(MAX30%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress3020008 = PartialDressBlueprint(
  id = 3020008,
  name = "フロンティア芸術学校",
  baseRarity = 4,
  cost = 12,
