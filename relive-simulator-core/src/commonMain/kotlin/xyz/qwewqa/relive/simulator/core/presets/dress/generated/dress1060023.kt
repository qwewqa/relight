...
val dress = dress1060023(
    name = "賢者",
    acts = listOf(
        ActType.Act1.blueprint("賢慮の導き") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
        ...
        ActType.ClimaxAct.blueprint("叡智の書") {
            Act {
                /*
...
val _dress1060023 = PartialDressBlueprint(
  id = 1060023,
  name = "賢者",
  baseRarity = 4,
  cost = 23,
