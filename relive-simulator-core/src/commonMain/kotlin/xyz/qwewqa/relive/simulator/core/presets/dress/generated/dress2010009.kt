...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress2010009
...
val dress = dress2010009(
    ...
    unitSkill = null /* 宙属性かつ、ACTタイプ[特殊]の舞台少女のACTパワーアップ %opt1_value%%(MAX30%) クリティカル威力アップ %opt2_value%%(MAX30%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress2010009 = PartialDressBlueprint(
  id = 2010009,
  name = "凛明館女学校",
  baseRarity = 4,
  cost = 12,
