...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1090019
...
val dress = dress1090019(
    name = "アイスクリーム",
    acts = listOf(
        ActType.Act1.blueprint("バニラ") {
            Act {
                /*
                継続プラス効果解除
        ...
        ActType.ClimaxAct.blueprint("SWEET BOMB") {
            Act {
                /*
    ...
    autoSkills = listOf(
        ...
        */
        ...
        /*
        auto skill 4:
          最大HPアップ(開幕時味方の舞台上にいる%attr%属性舞台少女1体につき%value%) (最大150％)
            target: 味方の雲属性
...
internal val _dress1090019 = PartialDressBlueprint(
  id = 1090019,
  name = "アイスクリーム",
  baseRarity = 4,
  cost = 20,
