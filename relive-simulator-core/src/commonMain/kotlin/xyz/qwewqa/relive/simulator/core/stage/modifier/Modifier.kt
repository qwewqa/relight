...
enum class Modifier {
  ...
  GreaterNegativeEffectResistanceUp,
  GreaterNegativeEffectResistanceDown,
  GreaterNegativeCountableEffectResistanceUp,
  GreaterNegativeCountableEffectResistanceDown,
