...
val accessory36 = PartialAccessoryBlueprint(
  id = 36,
  iconId = 900000601,
  name = "悲恋の薬瓶",
  baseHp = 11000,
  baseActPower = 1150,
  baseNormalDefense = 900,
  baseSpecialDefense = 900,
  baseDexterity = 10,
  baseCritical = 10,
  baseAgility = 500,
  maxHp = 22000,
  maxActPower = 2300,
  maxNormalDefense = 1800,
  maxSpecialDefense = 1800,
  maxDexterity = 30,
  maxCritical = 30,
  maxAgility = 1000,
  ...
  dressIds = setOf(1010019, 2050011, 4040010, 5010004),
)
