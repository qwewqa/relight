...
val dress = dress3050017(
    name = "舞台少女",
    acts = listOf(
        ActType.Act1.blueprint("神域の斬撃") {
            Act {
                /*
                継続マイナス効果解除
                  target: 前から3体の味方
        ...
        ActType.ClimaxAct.blueprint("その羽広げてすすめフロンティア！") {
            Act {
                /*
                通常防御力ダウン(%value%)
                  target: 前から3体の敵役
    ...
    unitSkill = null /* フロンティア芸術学校のACTパワーアップ %opt1_value%%(MAX50%) クリティカル威力アップ %opt2_value%%(MAX50%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress3050017 = PartialDressBlueprint(
  id = 3050017,
  name = "舞台少女",
  baseRarity = 4,
  cost = 15,
