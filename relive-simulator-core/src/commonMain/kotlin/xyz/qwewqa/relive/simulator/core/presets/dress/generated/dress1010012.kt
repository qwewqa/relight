...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1010012
...
val dress = dress1010012(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("Possibility of Puberty") {
            Act {
                /*
                %attr%属性攻撃(威力%value%) (ACTタイプ[通常]の敵役に特攻)
                  target: 前から1番目の敵役
    ...
    unitSkill = null /* 花属性かつ、ACTタイプ[特殊]の舞台少女のACTパワーアップ %opt1_value%%(MAX30%) クリティカル威力アップ %opt2_value%%(MAX30%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress1010012 = PartialDressBlueprint(
  id = 1010012,
  name = "聖翔音楽学園",
  baseRarity = 4,
  cost = 12,
