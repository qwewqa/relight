...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1010008
...
val dress = dress1010008(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("熱き音色") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 後ろから3体の敵役
...
internal val _dress1010008 = PartialDressBlueprint(
  id = 1010008,
  name = "アポロン",
  baseRarity = 4,
  cost = 12,
