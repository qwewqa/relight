...
val tr41KomachiTamaoStrategy = FixedStrategy {
...
val tr41KomachiTamaoDiff4 =
    ActorLoadout(
        "TR41 Komachi Tamao Difficulty 4",
        Dress(
            name = "Komachi Tamao",
            character = Character.Tamao,
            attribute = Attribute.Dream,
...
val tr41KomachiTamaoDiff4Strategy = FixedStrategy {
  val boss = this.team.actors.values.first()
