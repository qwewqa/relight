...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress4040002
...
val dress = dress4040002(
    ...
    acts = listOf(
        ...
        ActType.Act3.blueprint("癒し") {
            Act {
                /*
                HP回復(%value%)
                  target: HP割合が1番低い味方
                  hit_rate1: 100
                  values1: [440, 860, 1560, 2580, 3930]
                  times1: [0, 0, 0, 0, 0]
                */
            }
        },
        ActType.ClimaxAct.blueprint("ウーア・ゲヴァルト") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
...
val _dress4040002 = PartialDressBlueprint(
  id = 4040002,
  name = "風の神",
  baseRarity = 3,
  cost = 9,
