...
val tr31HangedManRuiStrategy = FixedStrategy {
...
val tr31HangedManRuiDiff4 =
    ActorLoadout(
        "TR31 Hanged Man Rui Difficulty 4",
        Dress(
            name = "Hanged Man Rui",
            character = Character.Rui,
            attribute = Attribute.Snow,
...
val tr31HangedManRuiDiff4Strategy = FixedStrategy {
  val boss = this.team.actors.values.first()
