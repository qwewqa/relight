...
val tr19SuirenYuyuko = ActorLoadout(
    "TR19 Suiren Yuyuko",
    Dress(
        name = "Suiren Yuyuko",
...
val tr19SuirenYuyukoStrategy = FixedStrategy {
...
val tr19SuirenYuyukoDiff4 = ActorLoadout(
    "TR19 Suiren Yuyuko Difficulty 4",
    Dress(
        name = "Suiren Yuyuko",
        character = Character.Yuyuko,
        attribute = Attribute.Snow,
...
val tr19SuirenYuyukoDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
