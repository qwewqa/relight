...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress2010011
...
val dress = dress2010011(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("チアフルスマイル♪") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
...
internal val _dress2010011 = PartialDressBlueprint(
  id = 2010011,
  name = "神宮寺麗華",
  baseRarity = 4,
  cost = 12,
