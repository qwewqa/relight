...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress3030002
...
val dress = dress3030002(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("ララフィンボンバー！") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
    ...
    unitSkill = null /* 風属性の舞台少女の最大HPアップ %opt1_value%%(MAX10%) 通常防御力アップ %opt2_value%%(MAX5%) 特殊防御力アップ %opt3_value%%(MAX5%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress3030002 = PartialDressBlueprint(
  id = 3030002,
  name = "海賊女王の用心棒",
  baseRarity = 3,
  cost = 9,
