...
val tr22VampireShiori = ActorLoadout(
    "TR22 Vampire Shiori",
    Dress(
        name = "Vampire Shiori",
...
val tr22VampireShioriStrategy = FixedStrategy {
...
val tr22VampireShioriDiff4 = ActorLoadout(
    "TR22 Vampire Shiori Difficulty 4",
    Dress(
        name = "Vampire Shiori",
        character = Character.Shiori,
        attribute = Attribute.Cloud,
...
val tr22VampireShioriDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
