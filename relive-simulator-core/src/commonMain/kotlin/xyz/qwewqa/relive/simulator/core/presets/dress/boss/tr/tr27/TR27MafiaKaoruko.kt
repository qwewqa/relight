...
val tr27MafiaKaoruko = ActorLoadout(
    "TR27 Mafia Kaoruko",
    Dress(
        name = "Mafia Kaoruko",
...
val tr27MafiaKaorukoStrategy = FixedStrategy {
...
val tr27MafiaKaorukoDiff4 = ActorLoadout(
    "TR27 Mafia Kaoruko Difficulty 4",
    Dress(
        name = "Mafia Kaoruko",
        character = Character.Kaoruko,
        attribute = Attribute.Dream,
...
val tr27MafiaKaorukoDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
