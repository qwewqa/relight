...
val tr31KomachiTamaoStrategy = FixedStrategy {
...
val tr31KomachiTamaoDiff4 =
    ActorLoadout(
        "TR31 Komachi Tamao Difficulty 4",
        Dress(
            name = "Komachi Tamao",
            character = Character.Tamao,
            attribute = Attribute.Dream,
...
val tr31KomachiTamaoDiff4Strategy = FixedStrategy {
  val boss = this.team.actors.values.first()
