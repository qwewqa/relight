...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1080003
...
val dress = dress1080003(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("猫のお返し") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
...
internal val _dress1080003 = PartialDressBlueprint(
  id = 1080003,
  name = "長靴をはいた猫",
  baseRarity = 4,
  cost = 12,
