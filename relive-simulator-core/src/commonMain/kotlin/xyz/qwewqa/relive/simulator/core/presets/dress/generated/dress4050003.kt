...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress4050003
...
val dress = dress4050003(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("紅蓮の雨") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
    ...
    unitSkill = null /* 風属性の舞台少女のACTパワーアップ %opt1_value%%(MAX5%) クリティカル威力アップ %opt2_value%%(MAX5%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress4050003 = PartialDressBlueprint(
  id = 4050003,
  name = "貂蝉",
  baseRarity = 3,
  cost = 9,
