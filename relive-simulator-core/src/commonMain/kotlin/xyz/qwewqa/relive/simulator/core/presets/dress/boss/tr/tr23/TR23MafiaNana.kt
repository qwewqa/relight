...
val tr23MafiaNana = ActorLoadout(
    "TR23 Mafia Nana",
    Dress(
        name = "Mafia Nana",
...
val tr23MafiaNanaStrategy = FixedStrategy {
...
val tr23MafiaNanaDiff4 = ActorLoadout(
    "TR23 Mafia Nana Difficulty 4",
    Dress(
        name = "Mafia Nana",
        character = Character.Nana,
        attribute = Attribute.Dream,
...
val tr23MafiaNanaDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
