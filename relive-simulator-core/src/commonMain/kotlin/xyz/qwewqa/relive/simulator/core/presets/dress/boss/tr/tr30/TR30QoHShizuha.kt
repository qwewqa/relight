...
val tr30QueenOfHeartsShizuha =
    ActorLoadout(
        "TR30 Queen of Hearts Shizuha",
        Dress(
...
val tr30QueenOfHeartsShizuhaStrategy = FixedStrategy {
...
val tr30QueenOfHeartsShizuhaDiff4 =
    ActorLoadout(
        "TR30 Queen of Hearts Shizuha Difficulty 4",
        Dress(
            name = "Queen of Hearts Shizuha",
            character = Character.Shizuha,
            attribute = Attribute.Dream,
...
val tr30QueenOfHeartsShizuhaDiff4Strategy = FixedStrategy {
  val boss = this.team.actors.values.first()
