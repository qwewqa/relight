...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1060022
...
val dress = dress1060022(
    name = "バルドル",
    acts = listOf(
        ActType.Act1.blueprint("渾身の一撃") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
        ...
        ActType.ClimaxAct.blueprint("慈愛の光") {
            Act {
                /*
                神がかり (解除不可)
                  target: 自身
...
internal val _dress1060022 = PartialDressBlueprint(
  id = 1060022,
  name = "バルドル",
  baseRarity = 4,
  cost = 20,
