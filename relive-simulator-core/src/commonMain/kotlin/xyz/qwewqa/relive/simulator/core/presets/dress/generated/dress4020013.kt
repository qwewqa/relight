...
val dress = dress4020013(
    ...
    acts = listOf(
        ...
        ActType.Act3.blueprint("万雷の斬撃") {
            Act {
                ...
                field_effects:
                  拍手万雷（雲） (value: 1, time: 6, target: allies)
                */
            }
        },
        ActType.ClimaxAct.blueprint("聖罰の十字架 Encore") {
            Act {
                /*
    ...
    unitSkill = null /* 雲・星属性の舞台少女のACTパワーアップ %opt1_value%%(MAX100%) クリティカル威力アップ %opt2_value%%(MAX100%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

val dress4020013 = PartialDressBlueprint(
  id = 4020013,
  name = "ヘルシング Encore",
  baseRarity = 4,
  cost = 23,
