...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress4020010
...
val dress = dress4020010(
    ...
    acts = listOf(
        ...
        ActType.Act3.blueprint("元気の歌") {
            Act {
                /*
                毎ターンHP回復(%value%)
                  target: 自身
                  hit_rate1: 100
                  values1: [80, 160, 300, 510, 810]
                  times1: [4, 4, 4, 4, 4]
                */
            }
        },
...
internal val _dress4020010 = PartialDressBlueprint(
  id = 4020010,
  name = "シークフェルト音楽学院",
  baseRarity = 3,
  cost = 9,
