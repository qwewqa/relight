...
val tr25SetsunaIchie = ActorLoadout(
    "TR25 Setsuna Ichie",
    Dress(
        name = "Setsuna Ichie",
...
val tr25SetsunaIchieStrategy = FixedStrategy {
...
val tr25SetsunaIchieDiff4 = ActorLoadout(
    "TR25 Setsuna Ichie Difficulty 4",
    Dress(
        name = "Setsuna Ichie",
        character = Character.Ichie,
        attribute = Attribute.Dream,
...
val tr25SetsunaIchieDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
