...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress3040011
...
val dress = dress3040011(
    ...
    unitSkill = null /* フロンティア芸術学校かつ、風属性の舞台少女のACTパワーアップ %opt1_value%%(MAX30%) クリティカル威力アップ %opt2_value%%(MAX30%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress3040011 = PartialDressBlueprint(
  id = 3040011,
  name = "フロンティア芸術学校",
  baseRarity = 4,
  cost = 12,
