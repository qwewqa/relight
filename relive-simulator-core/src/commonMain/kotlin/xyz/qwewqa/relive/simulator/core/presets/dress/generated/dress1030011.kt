...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1030011
...
val dress = dress1030011(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("おみくじ運試し") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
...
val _dress1030011 = PartialDressBlueprint(
  id = 1030011,
  name = "巫女ヒフミ",
  baseRarity = 4,
  cost = 12,
