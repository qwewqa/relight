...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1040008
...
val dress = dress1040008(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("ブラッディ・ミッドナイト") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
...
val _dress1040008 = PartialDressBlueprint(
  id = 1040008,
  name = "ドラキュラ",
  baseRarity = 4,
  cost = 12,
