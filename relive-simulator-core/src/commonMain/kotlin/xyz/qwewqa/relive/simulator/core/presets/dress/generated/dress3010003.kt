...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress3010003
...
val dress = dress3010003(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("夢叶いの魔法") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
...
internal val _dress3010003 = PartialDressBlueprint(
  id = 3010003,
  name = "妖精の魔法使い",
  baseRarity = 3,
  cost = 9,
