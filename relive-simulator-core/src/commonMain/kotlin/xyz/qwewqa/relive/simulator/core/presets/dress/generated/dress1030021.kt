...
val dress = dress1030021(
    name = "コノハナサクヤヒメ",
    acts = listOf(
        ActType.Act1.blueprint("光花") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
        ...
        ActType.ClimaxAct.blueprint("東雲の飛花") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
...
internal val _dress1030021 = PartialDressBlueprint(
  id = 1030021,
  name = "コノハナサクヤヒメ",
  baseRarity = 4,
  cost = 20,
