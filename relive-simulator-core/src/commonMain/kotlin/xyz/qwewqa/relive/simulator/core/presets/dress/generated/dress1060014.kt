...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1060014
...
val dress = dress1060014(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("キラキラのダンス") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
...
internal val _dress1060014 = PartialDressBlueprint(
  id = 1060014,
  name = "スクールアイドル",
  baseRarity = 4,
  cost = 12,
