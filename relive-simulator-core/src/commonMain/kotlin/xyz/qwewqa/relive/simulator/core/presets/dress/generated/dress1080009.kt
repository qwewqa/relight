...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1080009
...
val dress = dress1080009(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("穢れなき騎士") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 後ろから3体の敵役
...
internal val _dress1080009 = PartialDressBlueprint(
  id = 1080009,
  name = "ガラハッド",
  baseRarity = 4,
  cost = 12,
