...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress2010006
...
val dress = dress2010006(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("捕まらぬ牙") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 後ろから3体の敵役
...
val _dress2010006 = PartialDressBlueprint(
  id = 2010006,
  name = "テウメッサの狐",
  baseRarity = 4,
  cost = 12,
