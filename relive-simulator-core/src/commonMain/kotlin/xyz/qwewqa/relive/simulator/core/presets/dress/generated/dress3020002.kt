...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress3020002
...
val dress = dress3020002(
        ...
        ActType.Act3.blueprint("快気の風") {
            Act {
                ...
                HP回復(%value%)
                  target: 味方全体
                  hit_rate3: 100
                  values3: [100, 200, 370, 610, 940]
                  times3: [0, 0, 0, 0, 0]
                */
            }
        },
        ActType.ClimaxAct.blueprint("メイルシュトローム") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
    ...
    unitSkill = null /* 雲属性の舞台少女のACTパワーアップ %opt1_value%%(MAX5%) クリティカル威力アップ %opt2_value%%(MAX5%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress3020002 = PartialDressBlueprint(
  id = 3020002,
  name = "駆け出し操舵士",
  baseRarity = 3,
  cost = 9,
