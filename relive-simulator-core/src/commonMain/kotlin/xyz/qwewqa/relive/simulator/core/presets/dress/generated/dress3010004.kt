...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress3010004
...
val dress = dress3010004(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("カラフルローリングエッグ") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前グループの敵役
...
val _dress3010004 = PartialDressBlueprint(
  id = 3010004,
  name = "イースターバニー",
  baseRarity = 4,
  cost = 12,
