...
val tr24AliceAruru = ActorLoadout(
    "TR24 Alice Aruru",
    Dress(
        name = "Alice Aruru",
...
val tr24AliceAruruStrategy = FixedStrategy {
...
val tr24AliceAruruDiff4 = ActorLoadout(
    "TR24 Alice Aruru Difficulty 4",
    Dress(
        name = "Alice Aruru",
        character = Character.Aruru,
        attribute = Attribute.Space,
...
val tr24AliceAruruDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
