...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress4030011
...
val dress = dress4030011(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("目覚めの口づけ") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から3体の敵役
...
internal val _dress4030011 = PartialDressBlueprint(
  id = 4030011,
  name = "白雪姫",
  baseRarity = 4,
  cost = 12,
