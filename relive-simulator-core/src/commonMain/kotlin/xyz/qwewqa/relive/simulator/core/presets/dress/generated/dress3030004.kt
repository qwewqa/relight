...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress3030004
...
val dress = dress3030004(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("必殺！ウサフィンショット") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
...
val _dress3030004 = PartialDressBlueprint(
  id = 3030004,
  name = "イースターバニー",
  baseRarity = 3,
  cost = 9,
