...
data class GenDress(
    ...
    val eva: Int,
    val friendship10_reward_adventure_id: Long,
    val friendship15_levelup_adventure_id: Long,
    val friendship25_reward_adventure_id: Long,
    val friendship30_levelup_adventure_id: Long,
