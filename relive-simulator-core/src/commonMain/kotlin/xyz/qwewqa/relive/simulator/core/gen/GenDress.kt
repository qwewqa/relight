...
data class GenDress(
    ...
    val eva: Int,
    val friendship10_reward_adventure_id: Int,
    val friendship15_levelup_adventure_id: Int,
    val friendship25_reward_adventure_id: Int,
    val friendship30_levelup_adventure_id: Int,
