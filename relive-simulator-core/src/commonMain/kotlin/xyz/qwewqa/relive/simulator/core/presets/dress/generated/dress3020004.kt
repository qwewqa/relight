...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress3020004
        ...
        ActType.Act3.blueprint("毒花") {
            Act {
                ...
                毒(%value%)
                  target: 前から1番目の敵役
                  hit_rate2: 100
                  values2: [70, 130, 230, 390, 610]
                  times2: [4, 4, 4, 4, 4]
                */
            }
        },
        ActType.ClimaxAct.blueprint("パンドラの箱") {
            Act {
                /*
...
internal val _dress3020004 = PartialDressBlueprint(
  id = 3020004,
  name = "パンドラ",
  baseRarity = 4,
  cost = 12,
