...
/**
 * Autoskill effects. Note that while the game itself differentiates between true passives and
 * before start passives, both are included here.
 */
interface PassiveEffect {
  val name: String
    get() = this::class.simpleName ?: "Unknown Passive"
...
/**
 * Tags associated with effects. This is not intended to correspond 1:1 with in-game tags. For
 * example, act up and damage up have been separated. An effect may also have more than one of
 * these.
 */
...
fun PassiveEffect.new(value: Int = 0, time: Int = 1) =
    PassiveData(
        this,
        value,
        time,
