...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1020002
...
val dress = dress1020002(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("黒獅子の断罪") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前グループの敵役
    ...
    unitSkill = null /* 宙属性の舞台少女の最大HPアップ %opt1_value%%(MAX10%) 通常防御力アップ %opt2_value%%(MAX5%) 特殊防御力アップ %opt3_value%%(MAX5%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress1020002 = PartialDressBlueprint(
  id = 1020002,
  name = "黒獅子の国の騎士",
  baseRarity = 3,
  cost = 9,
