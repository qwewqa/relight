...
val tr25KomachiTamao = ActorLoadout(
    "TR25 Komachi Tamao",
    Dress(
        name = "Komachi Tamao",
...
val tr25KomachiTamaoStrategy = FixedStrategy {
...
val tr25KomachiTamaoDiff4 = ActorLoadout(
    "TR25 Komachi Tamao Difficulty 4",
    Dress(
        name = "Komachi Tamao",
        character = Character.Tamao,
        attribute = Attribute.Dream,
...
val tr25KomachiTamaoDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
