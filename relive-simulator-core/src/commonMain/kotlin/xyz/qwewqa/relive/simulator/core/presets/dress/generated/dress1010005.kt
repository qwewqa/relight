...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1010005
...
val dress = dress1010005(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("トナカイ・ベル") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
...
internal val _dress1010005 = PartialDressBlueprint(
  id = 1010005,
  name = "赤鼻のトナカイ",
  baseRarity = 3,
  cost = 9,
