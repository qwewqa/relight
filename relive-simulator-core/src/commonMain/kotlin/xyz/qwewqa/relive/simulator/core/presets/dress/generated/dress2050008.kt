...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress2050008
...
val dress = dress2050008(
    ...
    unitSkill = null /* 凛明館女学校かつ、雲属性の舞台少女のACTパワーアップ %opt1_value%%(MAX30%) クリティカル威力アップ %opt2_value%%(MAX30%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress2050008 = PartialDressBlueprint(
  id = 2050008,
  name = "凛明館女学校",
  baseRarity = 4,
  cost = 12,
