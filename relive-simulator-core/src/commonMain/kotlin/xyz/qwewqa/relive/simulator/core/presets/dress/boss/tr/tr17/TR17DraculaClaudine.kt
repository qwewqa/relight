...
val tr17DraculaClaudine = ActorLoadout(
    "TR17 Dracula Claudine",
    Dress(
...
val tr17DraculaClaudineStrategy = FixedStrategy {
...
val tr17DraculaClaudineDiff4 = ActorLoadout(
    "TR17 Dracula Claudine Difficulty 4",
    Dress(
        name = "Dracula Claudine",
        character = Character.Claudine,
        attribute = Attribute.Dream,
...
val tr17DraculaClaudineDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
