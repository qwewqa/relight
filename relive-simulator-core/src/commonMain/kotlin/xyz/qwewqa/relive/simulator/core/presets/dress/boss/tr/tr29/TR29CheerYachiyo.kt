...
val tr29CheerYachiyoStrategy = FixedStrategy {
...
val tr29CheerYachiyoDiff4 =
    ActorLoadout(
        "TR29 Cheer Yachiyo Difficulty 4",
        Dress(
            name = "Cheer Yachiyo",
            character = Character.Yachiyo,
            attribute = Attribute.Dream,
...
val tr29CheerYachiyoDiff4Strategy = FixedStrategy {
  val boss = this.team.actors.values.first()
