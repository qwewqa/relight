...
val tr24WhiteRabbitMisora = ActorLoadout(
    "TR24 White Rabbit Misora",
    Dress(
...
val tr24WhiteRabbitMisoraStrategy = FixedStrategy {
...
val tr24WhiteRabbitMisoraDiff4 = ActorLoadout(
    "TR24 White Rabbit Misora Difficulty 4",
    Dress(
        name = "White Rabbit Misora",
        character = Character.Misora,
        attribute = Attribute.Dream,
...
val tr24WhiteRabbitMisoraDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
