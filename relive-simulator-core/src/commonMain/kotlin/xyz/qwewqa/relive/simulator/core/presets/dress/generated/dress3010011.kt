...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress3010011
...
val dress = dress3010011(
    ...
    unitSkill = null /* 雪属性かつ、ACTタイプ[通常]の舞台少女の最大HPアップ %opt1_value%%(MAX50%) 通常防御力アップ %opt2_value%%(MAX30%) 特殊防御力アップ %opt3_value%%(MAX30%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress3010011 = PartialDressBlueprint(
  id = 3010011,
  name = "フロンティア芸術学校",
  baseRarity = 4,
  cost = 12,
