...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress2050002
...
val dress = dress2050002(
        ...
        ActType.Act3.blueprint("毒花") {
            Act {
                ...
                毒(%value%)
                  target: 前から1番目の敵役
                  hit_rate2: 100
                  values2: [50, 100, 190, 330, 520]
                  times2: [4, 4, 4, 4, 4]
                */
            }
        },
        ActType.ClimaxAct.blueprint("紅葉千秋　一枚目") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前グループの敵役
                  hit_rate1: 100
                  values1: [178, 187, 196, 205, 214]
                  times1: 1
                毒(%value%)
                  target: 前グループの敵役
                  hit_rate2: 100
                  values2: [100, 200, 380, 640, 1010]
                  times2: [4, 4, 4, 4, 4]
                */
            }
        }
    ...
    unitSkill = null /* 月属性の舞台少女のACTパワーアップ %opt1_value%%(MAX5%) クリティカル威力アップ %opt2_value%%(MAX5%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress2050002 = PartialDressBlueprint(
  id = 2050002,
  name = "あやかし見廻り隊 隊士",
  baseRarity = 3,
  cost = 9,
