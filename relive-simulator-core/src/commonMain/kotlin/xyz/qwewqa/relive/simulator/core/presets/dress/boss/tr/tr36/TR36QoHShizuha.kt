...
val tr36QueenOfHeartsShizuha =
    ActorLoadout(
        "TR36 Queen of Hearts Shizuha",
        Dress(
...
val tr36QueenOfHeartsShizuhaStrategy = FixedStrategy {
...
val tr36QueenOfHeartsShizuhaDiff4 =
    ActorLoadout(
        "TR36 Queen of Hearts Shizuha Difficulty 4",
        Dress(
            name = "Queen of Hearts Shizuha",
            character = Character.Shizuha,
            attribute = Attribute.Dream,
...
val tr36QueenOfHeartsShizuhaDiff4Strategy = FixedStrategy {
  val boss = this.team.actors.values.first()
