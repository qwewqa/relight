...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress3020003
...
val dress = dress3020003(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("騎士道の心得") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
...
internal val _dress3020003 = PartialDressBlueprint(
  id = 3020003,
  name = "ドン・キホーテ",
  baseRarity = 4,
  cost = 12,
