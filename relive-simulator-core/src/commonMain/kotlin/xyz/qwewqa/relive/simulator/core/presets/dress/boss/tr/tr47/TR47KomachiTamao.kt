...
val tr47KomachiTamaoStrategy = FixedStrategy {
...
val tr47KomachiTamaoDiff4 =
    ActorLoadout(
        "TR47 Komachi Tamao Difficulty 4",
        Dress(
            name = "Komachi Tamao",
            character = Character.Tamao,
            attribute = Attribute.Space,
...
val tr47KomachiTamaoDiff4Strategy = FixedStrategy {
  val boss = this.team.actors.values.first()
