...
val dress = dress3040017(
    name = "舞台少女",
    acts = listOf(
        ActType.Act1.blueprint("浄化の一閃") {
            Act {
                /*
                継続マイナス効果解除
                  target: 味方全体
        ...
        ActType.ClimaxAct.blueprint("胸ときめかせてすすめフロンティア！") {
            Act {
                /*
...
internal val _dress3040017 = PartialDressBlueprint(
  id = 3040017,
  name = "舞台少女",
  baseRarity = 4,
  cost = 15,
