...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1090003
...
val dress = dress1090003(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("コウモリおみこし") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
                  hit_rate1: 100
                  values1: [271, 285, 298, 312, 326]
                  times1: 1
                ストップ
                  target: 前から1番目の敵役
                  hit_rate2: 100
...
internal val _dress1090003 = PartialDressBlueprint(
  id = 1090003,
  name = "悪戯なコウモリの魔女",
  baseRarity = 4,
  cost = 12,
