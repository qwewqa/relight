...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress4020005
...
val dress = dress4020005(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("新春晴傘かくし芸") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前グループの敵役
...
internal val _dress4020005 = PartialDressBlueprint(
  id = 4020005,
  name = "素敵な一年に！",
  baseRarity = 3,
  cost = 9,
