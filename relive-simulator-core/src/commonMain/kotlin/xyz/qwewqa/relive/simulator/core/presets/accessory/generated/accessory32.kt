...
val accessory32 = PartialAccessoryBlueprint(
  id = 32,
  iconId = 900000201,
  name = "わいわいビーチバレーボール",
  baseHp = 1000,
  baseActPower = 300,
  baseNormalDefense = 300,
  baseSpecialDefense = 300,
  baseDexterity = 10,
  baseCritical = 10,
  baseAgility = 100,
  maxHp = 4380,
  maxActPower = 1483,
  maxNormalDefense = 1483,
  maxSpecialDefense = 1483,
  maxDexterity = 45,
  maxCritical = 45,
  maxAgility = 438,
  ...
  dressIds = setOf(2040013, 4050016),
)
