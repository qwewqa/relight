...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1070007
...
val dress = dress1070007(
    ...
    acts = listOf(
        ...
        ActType.Act2.blueprint("キラめきの大盾") {
            Act {
                ...
                通常バリア(%value%)
                  target: 前から2体の味方
                  hit_rate1: 100
                  values1: [430, 730, 1210, 1990, 3030]
                  times1: [3, 3, 3, 3, 3]
                キラめき回復(%value%)
                  target: 自身
                  hit_rate2: 100
        ...
        ActType.ClimaxAct.blueprint("マーメイド　スプラッシュ") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
...
internal val _dress1070007 = PartialDressBlueprint(
  id = 1070007,
  name = "天海もも",
  baseRarity = 4,
  cost = 12,
