...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress4010011
...
val dress = dress4010011(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("夢叶えるビート") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
...
internal val _dress4010011 = PartialDressBlueprint(
  id = 4010011,
  name = "イニシャル ベース",
  baseRarity = 4,
  cost = 12,
