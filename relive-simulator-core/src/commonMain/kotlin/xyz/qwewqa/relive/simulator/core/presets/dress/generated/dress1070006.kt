...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1070006
...
val dress = dress1070006(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("巌流島の決闘") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から3体の敵役
...
internal val _dress1070006 = PartialDressBlueprint(
  id = 1070006,
  name = "宮本武蔵",
  baseRarity = 4,
  cost = 12,
