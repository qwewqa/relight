...
val tr30WhiteRabbitMisora =
    ActorLoadout(
        "TR30 White Rabbit Misora",
        Dress(
...
val tr30WhiteRabbitMisoraStrategy = FixedStrategy {
...
val tr30WhiteRabbitMisoraDiff4 =
    ActorLoadout(
        "TR30 White Rabbit Misora Difficulty 4",
        Dress(
            name = "White Rabbit Misora",
            character = Character.Misora,
            attribute = Attribute.Dream,
...
val tr30WhiteRabbitMisoraDiff4Strategy = FixedStrategy {
  val boss = this.team.actors.values.first()
