...
val dress = dress2040017(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("命の在処この舞台に見つけたり！") {
            Act {
                /*
                継続プラス効果解除
                  target: 敵役全体
...
internal val _dress2040017 = PartialDressBlueprint(
  id = 2040017,
  name = "舞台少女",
  baseRarity = 4,
  cost = 15,
