package xyz.qwewqa.relive.simulator.core.presets.dress.boss.tr.tr33
...
val tr33MafiaKaoruko =
    ActorLoadout(
        ...
        Dress(
            ...
            autoSkills =
                listOf(
                    trEventBonusPassive2023V2(4010022),
                    AbnormalGuardPassive.new(),
                ),
        ),
    )

val tr33MafiaKaorukoStrategy = FixedStrategy {
...
val tr33MafiaKaorukoDiff4 =
    ActorLoadout(
        "TR33 Mafia Kaoruko Difficulty 4",
        Dress(
            name = "Mafia Kaoruko",
            character = Character.Kaoruko,
            attribute = Attribute.Dream,
...
val tr33MafiaKaorukoDiff4Strategy = FixedStrategy {
  val boss = this.team.actors.values.first()
