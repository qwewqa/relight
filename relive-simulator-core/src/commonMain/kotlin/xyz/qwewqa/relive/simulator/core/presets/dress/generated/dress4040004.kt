...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress4040004
...
val dress = dress4040004(
    ...
    acts = listOf(
        ...
        ActType.Act3.blueprint("祝福の泉") {
            Act {
                /*
                HP回復(%value%)
                  target: 味方全体
                  hit_rate1: 100
                  values1: [190, 320, 540, 890, 1350]
                  times1: [0, 0, 0, 0, 0]
                通常防御力アップ(%value%)
                  target: 味方全体
                  hit_rate2: 100
        ...
        ActType.ClimaxAct.blueprint("花のお守り") {
            Act {
                /*
                退場回避 (発動時に効果解除)
                  target: ACTパワーが高い1体の味方
                  hit_rate1: 100
                  values1: [0, 0, 0, 0, 0]
                  times1: [1, 2, 3, 4, 5]
                */
...
internal val _dress4040004 = PartialDressBlueprint(
  id = 4040004,
  name = "親指姫",
  baseRarity = 4,
  cost = 12,
