...
import xyz.qwewqa.relive.simulator.core.presets.dress.middle.flower.FinalLinesKaren
...
val tr21CheerTsukasa = ActorLoadout(
    "TR21 Cheer Tsukasa",
    Dress(
        name = "Cheer Tsukasa",
        ...
        autoSkills = listOf(
            trEventBonusPassive(FinalLinesKaren),
...
val tr21CheerTsukasaStrategy = FixedStrategy {
...
val tr21CheerTsukasaDiff4 = ActorLoadout(
    "TR21 Cheer Tsukasa Difficulty 4",
    Dress(
        name = "Cheer Tsukasa",
        character = Character.Tsukasa,
        attribute = Attribute.Wind,
...
val tr21CheerTsukasaDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
