...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1010009
...
val dress = dress1010009(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("正義の切っ先") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
...
internal val _dress1010009 = PartialDressBlueprint(
  id = 1010009,
  name = "怪傑ゾロ",
  baseRarity = 4,
  cost = 12,
