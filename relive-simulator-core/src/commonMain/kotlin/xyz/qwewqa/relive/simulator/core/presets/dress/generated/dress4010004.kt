...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress4010004
...
val dress = dress4010004(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("野獣の咆哮") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前グループの敵役
...
internal val _dress4010004 = PartialDressBlueprint(
  id = 4010004,
  name = "野獣",
  baseRarity = 3,
  cost = 9,
