...
val tr14MusketeerKaren = ActorLoadout(
    "TR14 Musketeer Karen",
    Dress(
...
val tr14MusketeerKarenStrategy = FixedStrategy {
...
val tr14MusketeerKarenDiff4 = ActorLoadout(
    "TR14 Musketeer Karen Difficulty 4",
    Dress(
        name = "Musketeer Karen",
        character = Character.Karen,
        attribute = Attribute.Dream,
...
val tr14MusketeerKarenDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
