...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress2040006
...
val dress = dress2040006(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("亀は急に止まれない") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
...
internal val _dress2040006 = PartialDressBlueprint(
  id = 2040006,
  name = "浦島太郎",
  baseRarity = 3,
  cost = 9,
