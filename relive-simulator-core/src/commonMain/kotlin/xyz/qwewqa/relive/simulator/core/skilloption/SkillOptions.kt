...
object SkillOptions : ImplementationRegistry<SkillOption>() {
    ...
    fun SkillOptionData.dispelTimedEffect(): ActiveSkillOption {
        ...
        return makeSkillOption { value, time ->
            dispelTimed(effect = effect)
        }
    }

    fun SkillOptionData.reduceCountable(): ActiveSkillOption {
        val effect = Buffs[params[0]] as? CountableBuffEffect ?: error("No buff effect for ${params[0]}")
    ...
    fun SkillOptionData.removeAllCountable(): ActiveSkillOption {
        ...
        return makeSkillOption { _ ->
            targets.forEach { target ->
                repeat(target.buffs.count(effect)) {
                    target.buffs.remove(effect)
                }
            }
        }
    ...
    val FixedHpRecovery = +skillOptionData(6).makeSkillOption { value, time, chance ->
        heal(fixed = value)
    }
    val PercentHpRecovery = +skillOptionData(7).makeSkillOption { value, time, chance ->
        heal(percent = value)
    }
    ...
    val BrillianceRecovery = +skillOptionData(89).makeSkillOption { value ->
        addBrilliance(value)
    }
    ...
    val DispelContinuousPositiveEffects = +skillOptionData(127).makeSkillOption { _ ->
        dispelTimed(BuffCategory.Positive)
    }
    val DispelContinuousNegativeEffects = +skillOptionData(128).makeSkillOption { _ ->
    ...
    val FlipNegativeEffects = +skillOptionData(151).makeSkillOption { value, time ->
    ...
    val HitRandom20Stop1t = +skillOptionData(230).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
    ...
    val DispelContinuousEffects = +skillOptionData(239).makeSkillOption { _ ->
        dispelTimed(BuffCategory.Positive)
        dispelTimed(BuffCategory.Negative)
    }
    ...
    val NormalBarrierPercent = +skillOptionData(242).makeSkillOption { value, time, chance ->
        applyTimedBuff(
    ...
    val SpecialBarrierPercent = +skillOptionData(243).makeSkillOption { value, time, chance ->
        applyTimedBuff(
    ...
    val HitRandom20Stun2t = +skillOptionData(262).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
    ...
    val HitRandom20Sleep2t = +skillOptionData(263).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
    ...
    val HitRandom20Confusion2t = +skillOptionData(264).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
    ...
    val HitRandom20Freeze2t = +skillOptionData(265).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
    ...
    val HitRandom20Blindness2t = +skillOptionData(266).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
    ...
    val AttackPoisonBoost = +skillOptionData(276).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackBurnBoost = +skillOptionData(277).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackProvokeBoost = +skillOptionData(278).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackStunBoost = +skillOptionData(279).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackSleepBoost = +skillOptionData(280).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackConfusionBoost = +skillOptionData(281).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackStopBoost = +skillOptionData(282).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackFreezeBoost = +skillOptionData(283).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackBlindnessBoost = +skillOptionData(284).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackHpRecoveryDownBoost = +skillOptionData(285).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackMarkBoost = +skillOptionData(286).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackAggroBoost = +skillOptionData(287).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackApUpBoost = +skillOptionData(288).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackSealAct1Boost = +skillOptionData(289).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackSealAct2Boost = +skillOptionData(290).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackSealAct3Boost = +skillOptionData(291).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackBrillianceGainDownBoost = +skillOptionData(292).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackNormalBoost125 = +skillOptionData(305).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 150,
    ...
    val AttackNormalBoost150 = +skillOptionData(306).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 150,
    ...
    val AttackSpecialBoost125 = +skillOptionData(307).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 150,
    ...
    val AttackSpecialBoost150 = +skillOptionData(308).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 150,
    ...
    val FocusAttack = +skillOptionData(310).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            focus = true,
...
//    val HeavyBurnResistanceUp = +skillOptionData(319).applyEffect()
    ...
    val AttackNonElementalSetDamage = +skillOptionData(320).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            mode = HitMode.FIXED,
    ...
    val FlipPositiveEffects = +skillOptionData(323).makeSkillOption { _, time ->
    ...
    val DispelPositiveEffects = +skillOptionData(338).makeSkillOption { _ ->
        dispelTimed(BuffCategory.Positive)
    ...
    val AttackLovesicknessBoost = +skillOptionData(345).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val BrillianceReduction = +skillOptionData(347).makeSkillOption { value ->
...
//    val LockedShockPercent = +skillOptionData(355).applyEffect()
    ...
    val AttackShockBoost = +skillOptionData(359).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackSeishoBoost150 = +skillOptionData(361).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 150,
    ...
    val AttackRinmeikanBoost150 = +skillOptionData(362).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 150,
    ...
    val AttackFrontierBoost150 = +skillOptionData(363).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 150,
    ...
    val AttackSiegfeldBoost150 = +skillOptionData(364).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 150,
    ...
    val AttackSeiranBoost150 = +skillOptionData(365).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 150,
    ...
    val HitRandom33Stop1t = +skillOptionData(371).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
            effect = Buffs.StopBuff,
    ...
    val HitRandom33Stun2t = +skillOptionData(372).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
            effect = Buffs.StunBuff,
    ...
    val HitRandom33Sleep2t = +skillOptionData(373).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
            effect = Buffs.SleepBuff,
    ...
    val HitRandom33Confusion2t = +skillOptionData(374).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
            effect = Buffs.ConfusionBuff,
    ...
    val HitRandom33Freeze2t = +skillOptionData(375).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
            effect = Buffs.FreezeBuff,
    ...
    val HitRandom33Blindness2t = +skillOptionData(376).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
            effect = Buffs.BlindnessBuff,
...
//    val NightmarePercent = +skillOptionData(378).applyEffect()
    ...
    val DispelCountablePositiveEffects = +skillOptionData(383).makeSkillOption { _ ->
        dispelCountable(BuffCategory.Positive)
    }
    ...
    val AttackFocusSeishoBoost = +skillOptionData(386).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackFocusRinmeikanBoost = +skillOptionData(387).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackFocusFrontierBoost = +skillOptionData(388).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackFocusSiegfeldBoost = +skillOptionData(389).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val AttackFocusSeiranBoost = +skillOptionData(390).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val HitRandom33Impudence5000v1x = +skillOptionData(391).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
    ...
    val HitRandom33Daze1x = +skillOptionData(393).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
    ...
    val AttackArcanaBoost = +skillOptionData(397).makeSkillOption { value, time ->
        attack(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val CurtainsClosed = +skillOptionData(442).makeSkillOption { _ ->
        // Noop in PvE
    }
    val LockedCurtainsClosed = +skillOptionData(443).makeSkillOption { _ ->
        // Noop in PvE
    }

    val CountableNegativeEffectsReduction = +skillOptionData(444).makeSkillOption { _, time ->
    ...
    val CountablePositiveEffectsReduction = +skillOptionData(453).makeSkillOption { _, time ->
    ...
    val AbsorbBrilliance = +skillOptionData(471).makeSkillOption { value ->
        absorbBrilliance(value)
    }
    ...
    fun SkillOptionData.scalingEffect(effect: TimedBuffEffect<Unit>, cap: Int, condition: (Actor) -> Boolean) = makeDualSkillOption(
        activeAction = { value, time, chance, _ ->
    ...
    fun SkillOptionData.scalingActPowerUp(cap: Int, condition: (Actor) -> Boolean) = scalingEffect(Buffs.ActPowerUpBuff, cap, condition)
    fun SkillOptionData.scalingMaxHpUp(cap: Int, condition: (Actor) -> Boolean) = scalingEffect(Buffs.MaxHpUpBuff, cap, condition)
    fun SkillOptionData.scalingEvasionUp(cap: Int, condition: (Actor) -> Boolean) = scalingEffect(Buffs.EvasionUpBuff, cap, condition)

    val ScalingActPowerUp120FlowerWindSnow = +skillOptionData(481).scalingActPowerUp(120) {
        it.dress.attribute.let { attr -> attr == Attribute.Flower || attr == Attribute.Wind || attr == Attribute.Snow }
    }
    val ScalingActPowerUp120MoonSpaceCloud = +skillOptionData(482).scalingActPowerUp(120) {
        it.dress.attribute.let { attr -> attr == Attribute.Moon || attr == Attribute.Space || attr == Attribute.Cloud }
    }
    ...
    val ConversionReviveToWeakSpot = +skillOptionData(488).makeSkillOption { _, time ->
        convertRevive(time)
    }

    val HitRandom33DazeSeishoBoost = +skillOptionData(489).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val HitRandom33DazeRinmeikanBoost = +skillOptionData(490).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val HitRandom33DazeFrontierBoost = +skillOptionData(491).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val HitRandom33DazeSiegfeldBoost = +skillOptionData(492).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val HitRandom33DazeSeiranBoost = +skillOptionData(493).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val ScalingActPowerUp100Seisho = +skillOptionData(503).scalingActPowerUp(100) {
        it.dress.character.school == School.Seisho
    }
    val ScalingActPowerUp100Rinmeikan = +skillOptionData(504).scalingActPowerUp(100) {
        it.dress.character.school == School.Rinmeikan
    }
    val ScalingActPowerUp100Frontier = +skillOptionData(505).scalingActPowerUp(100) {
        it.dress.character.school == School.Frontier
    }
    val ScalingActPowerUp100Siegfeld = +skillOptionData(506).scalingActPowerUp(100) {
        it.dress.character.school == School.Siegfeld
    }
    val ScalingActPowerUp100Seiran = +skillOptionData(507).scalingActPowerUp(100) {
        it.dress.character.school == School.Seiran
    }

    val LockedPerfectAim = +skillOptionData(508).applyEffect()

    val ConversionCountableNegativeEffectToRevive = +skillOptionData(509).makeSkillOption { _, time ->
        convertCountableNegative(time)
    }

    val StaminaActPowerUp = +skillOptionData(510).applyEffect()

    val Overwhelm = +skillOptionData(511).makeSkillOption { _ ->
        targets.forEach { target ->
            // Bypass resistances
    ...
    val ScalingActPowerUp40Flower = +skillOptionData(513).scalingActPowerUp(40) {
        it.dress.attribute == Attribute.Flower
    }
    val ScalingActPowerUp40Wind = +skillOptionData(514).scalingActPowerUp(40) {
        it.dress.attribute == Attribute.Wind
    }
    val ScalingActPowerUp40Snow = +skillOptionData(515).scalingActPowerUp(40) {
        it.dress.attribute == Attribute.Snow
    }
    val ScalingActPowerUp40Moon = +skillOptionData(516).scalingActPowerUp(40) {
        it.dress.attribute == Attribute.Moon
    }
    val ScalingActPowerUp40Space = +skillOptionData(517).scalingActPowerUp(40) {
        it.dress.attribute == Attribute.Space
    }
    val ScalingActPowerUp40Cloud = +skillOptionData(518).scalingActPowerUp(40) {
        it.dress.attribute == Attribute.Cloud
    }
    val ScalingActPowerUp40Dream = +skillOptionData(519).scalingActPowerUp(40) {
        it.dress.attribute == Attribute.Dream
    }

    val ScalingMaxHpUp40Flower = +skillOptionData(520).scalingMaxHpUp(40) {
        it.dress.attribute == Attribute.Flower
    }
    val ScalingMaxHpUp40Wind = +skillOptionData(521).scalingMaxHpUp(40) {
        it.dress.attribute == Attribute.Wind
    }
    val ScalingMaxHpUp40Snow = +skillOptionData(522).scalingMaxHpUp(40) {
        it.dress.attribute == Attribute.Snow
    }
    val ScalingMaxHpUp40Moon = +skillOptionData(523).scalingMaxHpUp(40) {
        it.dress.attribute == Attribute.Moon
    }
    val ScalingMaxHpUp40Space = +skillOptionData(524).scalingMaxHpUp(40) {
        it.dress.attribute == Attribute.Space
    }
    val ScalingMaxHpUp40Cloud = +skillOptionData(525).scalingMaxHpUp(40) {
        it.dress.attribute == Attribute.Cloud
    }
    val ScalingMaxHpUp40Dream = +skillOptionData(526).scalingMaxHpUp(40) {
        it.dress.attribute == Attribute.Dream
    }

    val ScalingActPowerUp100Flower = +skillOptionData(527).scalingActPowerUp(100) {
        it.dress.attribute == Attribute.Flower
    }
    val ScalingActPowerUp100Wind = +skillOptionData(528).scalingActPowerUp(100) {
        it.dress.attribute == Attribute.Wind
    }
    val ScalingActPowerUp100Snow = +skillOptionData(529).scalingActPowerUp(100) {
        it.dress.attribute == Attribute.Snow
    }
    val ScalingActPowerUp100Moon = +skillOptionData(530).scalingActPowerUp(100) {
        it.dress.attribute == Attribute.Moon
    }
    val ScalingActPowerUp100Space = +skillOptionData(531).scalingActPowerUp(100) {
        it.dress.attribute == Attribute.Space
    }
    val ScalingActPowerUp100Cloud = +skillOptionData(532).scalingActPowerUp(100) {
        it.dress.attribute == Attribute.Cloud
    }
    val ScalingActPowerUp100Dream = +skillOptionData(533).scalingActPowerUp(100) {
        it.dress.attribute == Attribute.Dream
    }

    val ScalingMaxHpUp150Flower = +skillOptionData(534).scalingMaxHpUp(150) {
        it.dress.attribute == Attribute.Flower
    }
    val ScalingMaxHpUp150Wind = +skillOptionData(535).scalingMaxHpUp(150) {
        it.dress.attribute == Attribute.Wind
    }
    val ScalingMaxHpUp150Snow = +skillOptionData(536).scalingMaxHpUp(150) {
        it.dress.attribute == Attribute.Snow
    }
    val ScalingMaxHpUp150Moon = +skillOptionData(537).scalingMaxHpUp(150) {
        it.dress.attribute == Attribute.Moon
    }
    val ScalingMaxHpUp150Space = +skillOptionData(538).scalingMaxHpUp(150) {
        it.dress.attribute == Attribute.Space
    }
    val ScalingMaxHpUp150Cloud = +skillOptionData(539).scalingMaxHpUp(150) {
        it.dress.attribute == Attribute.Cloud
    }
    val ScalingMaxHpUp150Dream = +skillOptionData(540).scalingMaxHpUp(150) {
        it.dress.attribute == Attribute.Dream
    }

    val ScalingEvasionUp60Flower = +skillOptionData(541).scalingEvasionUp(60) {
        it.dress.attribute == Attribute.Flower
    }
    val ScalingEvasionUp60Wind = +skillOptionData(542).scalingEvasionUp(60) {
        it.dress.attribute == Attribute.Wind
    }
    val ScalingEvasionUp60Snow = +skillOptionData(543).scalingEvasionUp(60) {
        it.dress.attribute == Attribute.Snow
    }
    val ScalingEvasionUp60Moon = +skillOptionData(544).scalingEvasionUp(60) {
        it.dress.attribute == Attribute.Moon
    }
    val ScalingEvasionUp60Space = +skillOptionData(545).scalingEvasionUp(60) {
        it.dress.attribute == Attribute.Space
    }
    val ScalingEvasionUp60Cloud = +skillOptionData(546).scalingEvasionUp(60) {
        it.dress.attribute == Attribute.Cloud
    }
    val ScalingEvasionUp60Dream = +skillOptionData(547).scalingEvasionUp(60) {
        it.dress.attribute == Attribute.Dream
    }

    val DispelCountableNegativeEffects = +skillOptionData(548).makeSkillOption { _ ->
    ...
    val HitRandom33ImpudenceSeishoBoost = +skillOptionData(551).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val HitRandom33ImpudenceRinmeikanBoost = +skillOptionData(552).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val HitRandom33ImpudenceFrontierBoost = +skillOptionData(553).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val HitRandom33ImpudenceSiegfeldBoost = +skillOptionData(554).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
    ...
    val HitRandom33ImpudenceSeiranBoost = +skillOptionData(555).makeSkillOption { value, time ->
        attackWithDebuff(
            modifier = value,
            hitCount = time,
            bonusMultiplier = 200,
