...
val dress = dress1090013(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("来たれ、地獄の業火よ") {
            Act {
                /*
                継続マイナス効果解除
                  target: 味方全体
...
val _dress1090013 = PartialDressBlueprint(
  id = 1090013,
  name = "悪魔",
  baseRarity = 4,
  cost = 15,
