...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress4010002
...
val dress = dress4010002(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("メテオール・シュトラール") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
...
internal val _dress4010002 = PartialDressBlueprint(
  id = 4010002,
  name = "天の神",
  baseRarity = 4,
  cost = 12,
