...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1040013
...
val dress = dress1040013(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("Etincelle de Fierté") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
    ...
    unitSkill = null /* 聖翔音楽学園かつ、風属性の舞台少女のACTパワーアップ %opt1_value%%(MAX30%) クリティカル威力アップ %opt2_value%%(MAX30%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

internal val _dress1040013 = PartialDressBlueprint(
  id = 1040013,
  name = "聖翔音楽学園",
  baseRarity = 4,
  cost = 12,
