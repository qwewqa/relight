...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1020007
...
val dress = dress1020007(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("幸せの花束") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
...
internal val _dress1020007 = PartialDressBlueprint(
  id = 1020007,
  name = "花嫁 ジューン",
  baseRarity = 4,
  cost = 12,
