...
val dress = dress1020024(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("神楽ひかり 私がスタァだ！") {
            Act {
                /*
                ...
                field_effects:
                  ここが舞台だ (value: 1, time: 3, target: allies)
                */
            }
        }
    ),
...
internal val _dress1020024 = PartialDressBlueprint(
  id = 1020024,
  name = "最後のセリフ",
  baseRarity = 4,
  cost = 20,
