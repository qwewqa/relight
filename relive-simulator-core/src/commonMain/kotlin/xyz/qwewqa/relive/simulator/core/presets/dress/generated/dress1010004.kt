...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1010004
...
val dress = dress1010004(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("選ばれし王") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
                  hit_rate1: 100
                  values1: [105, 110, 115, 121, 126]
                  times1: 3
...
internal val _dress1010004 = PartialDressBlueprint(
  id = 1010004,
  name = "アーサー",
  baseRarity = 4,
  cost = 12,
