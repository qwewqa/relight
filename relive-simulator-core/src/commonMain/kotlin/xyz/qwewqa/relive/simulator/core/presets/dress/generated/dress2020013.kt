...
val dress = dress2020013(
    name = "音無巡査",
    acts = listOf(
        ActType.Act1.blueprint("譲り合い") {
            Act {
                /*
                継続マイナス効果解除
                  target: 味方全体
        ...
        ActType.ClimaxAct.blueprint("音無巡査の交通整理") {
            Act {
                /*
...
internal val _dress2020013 = PartialDressBlueprint(
  id = 2020013,
  name = "音無巡査",
  baseRarity = 4,
  cost = 20,
