...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress3010007
...
val dress = dress3010007(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("オオカミさんは倒さなきゃ！") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
...
internal val _dress3010007 = PartialDressBlueprint(
  id = 3010007,
  name = "赤ずきん",
  baseRarity = 4,
  cost = 12,
