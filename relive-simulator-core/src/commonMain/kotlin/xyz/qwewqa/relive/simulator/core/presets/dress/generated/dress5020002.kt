...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress5020002
...
val dress = dress5020002(
    ...
    acts = listOf(
        ...
        ActType.ClimaxAct.blueprint("猛将の雄叫び") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
                ...
                field_effects:
                  火煙轟々 (value: 1, time: 3, target: enemies)
                */
            }
        }
    ),
...
val _dress5020002 = PartialDressBlueprint(
  id = 5020002,
  name = "張飛",
  baseRarity = 4,
  cost = 13,
