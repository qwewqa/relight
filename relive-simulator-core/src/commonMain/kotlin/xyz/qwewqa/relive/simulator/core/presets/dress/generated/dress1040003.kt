...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress1040003
        ...
        ActType.Act3.blueprint("柔和の独奏") {
            Act {
                ...
                特殊防御力ダウン(%value%)
                  target: 前から1番目の敵役
                  hit_rate3: 100
                  values3: [8, 9, 10, 11, 12]
                  times3: [3, 3, 3, 3, 3]
                */
            }
        },
        ActType.ClimaxAct.blueprint("薔薇の輪舞曲") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
...
internal val _dress1040003 = PartialDressBlueprint(
  id = 1040003,
  name = "紅き公爵 リシュリュー",
  baseRarity = 3,
  cost = 9,
