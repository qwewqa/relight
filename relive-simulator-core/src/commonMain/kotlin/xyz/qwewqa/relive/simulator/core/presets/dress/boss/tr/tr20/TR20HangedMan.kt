...
val tr20HangedManRui = ActorLoadout(
    "TR20 Hanged Man Rui",
    Dress(
        name = "Hanged Man Rui",
...
val tr20HangedManRuiStrategy = FixedStrategy {
...
val tr20HangedManRuiDiff4 = ActorLoadout(
    "TR20 Hanged Man Rui Difficulty 4",
    Dress(
        name = "Hanged Man Rui",
        character = Character.Rui,
        attribute = Attribute.Moon,
...
val tr20HangedManRuiDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
