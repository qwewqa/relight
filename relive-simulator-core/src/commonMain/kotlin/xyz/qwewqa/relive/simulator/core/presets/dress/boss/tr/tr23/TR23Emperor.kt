...
val tr23EmperorAkira = ActorLoadout(
    "TR23 Emperor Akira",
    Dress(
        name = "Emperor Akira",
...
val tr23EmperorAkiraStrategy = FixedStrategy {
...
val tr23EmperorAkiraDiff4 = ActorLoadout(
    "TR23 Emperor Akira Difficulty 4",
    Dress(
        name = "Emperor Akira",
        character = Character.Akira,
        attribute = Attribute.Flower,
...
val tr23EmperorAkiraDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
