...
val tr41HangedManRuiStrategy = FixedStrategy {
...
val tr41HangedManRuiDiff4 =
    ActorLoadout(
        "TR41 Hanged Man Rui Difficulty 4",
        Dress(
            name = "Hanged Man Rui",
            character = Character.Rui,
            attribute = Attribute.Wind,
...
val tr41HangedManRuiDiff4Strategy = FixedStrategy {
  val boss = this.team.actors.values.first()
