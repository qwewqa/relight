...
val tr42MusketeerMahiru =
    ActorLoadout(
        "TR42 Musketeer Mahiru",
        Dress(
...
val tr42MusketeerMahiruStrategy = FixedStrategy {
...
val tr42MusketeerMahiruDiff4 =
    ActorLoadout(
        "TR42 Musketeer Mahiru Difficulty 4",
        Dress(
            name = "Musketeer Mahiru",
            character = Character.Mahiru,
            attribute = Attribute.Dream,
...
val tr42MusketeerMahiruDiff4Strategy = FixedStrategy {
  val boss = this.team.actors.values.first()
