...
val dress = dress4050019(
    name = "舞台少女コレクション",
    acts = listOf(
        ActType.Act1.blueprint("魅惑のポーズ") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
        ...
        ActType.Act2.blueprint("魅惑のウォーキング") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: ACTパワーが1番高い敵役
        ...
        ActType.Act3.blueprint("魅惑のスマイル") {
            Act {
                /*
                キラめき回復(%value%)
                  target: 後ろから5体の味方
        ...
        ActType.ClimaxAct.blueprint("鶴姫やちよのランウェイ") {
            Act {
                /*
                希望
                  target: 自身
...
internal val _dress4050019 = PartialDressBlueprint(
  id = 4050019,
  name = "舞台少女コレクション",
  baseRarity = 4,
  cost = 20,
