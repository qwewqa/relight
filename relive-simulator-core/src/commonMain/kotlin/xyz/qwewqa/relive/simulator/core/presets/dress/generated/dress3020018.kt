...
val dress = dress3020018(
    name = "フロンブルー",
    acts = listOf(
        ActType.Act1.blueprint("英気の一閃") {
            Act {
                /*
                AP減少
                  target: 味方全体
        ...
        ActType.Act2.blueprint("溌剌な一閃") {
            Act {
                ...
                field_effects:
                  希望の荒野 (value: 1, time: 2, target: allies)
                */
            }
        },
        ActType.Act3.blueprint("旺然たる一閃") {
            Act {
                /*
                クリティカル威力アップ(%value%)
                  target: 味方全体
        ...
        ActType.ClimaxAct.blueprint("スカイブルーコンビシューティング") {
            Act {
                /*
...
internal val _dress3020018 = PartialDressBlueprint(
  id = 3020018,
  name = "フロンブルー",
  baseRarity = 4,
  cost = 23,
