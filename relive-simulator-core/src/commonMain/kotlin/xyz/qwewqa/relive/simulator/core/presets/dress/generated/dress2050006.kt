...
import xyz.qwewqa.relive.simulator.core.presets.dress.generated.dress2050006
...
val dress = dress2050006(
    name = "赤ずきん",
    acts = listOf(
        ActType.Act1.blueprint("庇護の一撃") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 前から1番目の敵役
        ...
        ActType.ClimaxAct.blueprint("助けて！オオカミさん") {
            Act {
                /*
                %attr%属性攻撃(威力%value%)
                  target: 敵役全体
...
internal val _dress2050006 = PartialDressBlueprint(
  id = 2050006,
  name = "赤ずきん",
  baseRarity = 4,
  cost = 12,
