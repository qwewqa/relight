...
val tr27MafiaMaya = ActorLoadout(
    "TR27 Mafia Maya",
    Dress(
        name = "Mafia Maya",
...
val tr27MafiaMayaStrategy = FixedStrategy {
...
val tr27MafiaMayaDiff4 = ActorLoadout(
    "TR27 Mafia Maya Difficulty 4",
    Dress(
        name = "Mafia Maya",
        character = Character.Maya,
        attribute = Attribute.Flower,
...
val tr27MafiaMayaDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
