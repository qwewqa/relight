...
val dress = dress3040020(
    name = "奔放なクモの魔女 Encore",
    acts = listOf(
        ...
        ActType.Act3.blueprint("万雷の一閃") {
            Act {
                ...
                field_effects:
                  拍手万雷（風） (value: 1, time: 6, target: allies)
                */
            }
        },
        ActType.ClimaxAct.blueprint("パンプキントリック Encore") {
            Act {
                /*
    ...
    unitSkill = null /* 風・陽属性の舞台少女のACTパワーアップ %opt1_value%%(MAX100%) クリティカル威力アップ %opt2_value%%(MAX100%) */,
    multipleCA = false,
    categories = setOf(),
)
*/

val _dress3040020 = PartialDressBlueprint(
  id = 3040020,
  name = "奔放なクモの魔女 Encore",
  baseRarity = 4,
  cost = 23,
