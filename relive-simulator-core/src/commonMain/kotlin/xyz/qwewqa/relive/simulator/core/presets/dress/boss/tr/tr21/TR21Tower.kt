...
val tr21TowerHikari = ActorLoadout(
    "TR21 Tower Hikari",
    Dress(
        name = "Tower Hikari",
...
val tr21TowerHikariStrategy = FixedStrategy {
...
val tr21TowerHikariDiff4 = ActorLoadout(
    "TR21 Tower Hikari Difficulty 4",
    Dress(
        name = "Tower Hikari",
        character = Character.Hikari,
        attribute = Attribute.Wind,
...
val tr21TowerHikariDiff4Strategy = FixedStrategy {
    val boss = this.team.actors.values.first()
