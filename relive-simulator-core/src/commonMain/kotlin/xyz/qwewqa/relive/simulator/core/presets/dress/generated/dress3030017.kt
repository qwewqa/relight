...
val dress = dress3030017(
    name = "舞台少女",
    acts = listOf(
        ActType.Act1.blueprint("浄化の打撃") {
            Act {
                /*
                継続マイナス効果解除
                  target: 味方全体
        ...
        ActType.ClimaxAct.blueprint("愛と勇気ですすめフロンティア！") {
            Act {
                /*
...
internal val _dress3030017 = PartialDressBlueprint(
  id = 3030017,
  name = "舞台少女",
  baseRarity = 4,
  cost = 15,
