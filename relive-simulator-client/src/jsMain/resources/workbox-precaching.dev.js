...
this.workbox.precaching = (function (exports, assert_js, cacheNames_js, logger_js, WorkboxError_js, waitUntil_js, copyResponse_js, getFriendlyURL_js, Strategy_js, registerRoute_js, Route_js) {
    ...
    */
    ...
    class PrecacheController {
      ...
      constructor({
        ...
        this._concurrentRequests = concurrentRequests && concurrentRequests > 0 ? concurrentRequests : 1; // Bind the install and activate methods to the instance.
    ...
    */
    ...
    const getOrCreatePrecacheController = options => {
