...
fun updateLogFilter(
    ...
    simulation: Simulation, result: SimulationResult,
) {
    ...
    logFilterContainer.append {
        ...
        suspend fun updateLogDisplay(request: FilterLogRequest) {
            ...
            if (lastRequest == request) {
                ...
                document.getElementsByClassName("log-filter-nav-button-back")
                    .multiple<HTMLButtonElement>()
                    .forEach { it.disabled = request.index == 0 }
                document.getElementsByClassName("log-filter-nav-button-forward")
                    .multiple<HTMLButtonElement>()
            ...
            div(classes = "col-auto") {
                button(classes = "btn btn-primary") {
                    ...
                    onClickFunction = {
                        GlobalScope.launch {
                            val minDamageInput =
                                document.getElementById("log-min-damage-input")
                                    .shorthandIntegerInput()
                            val maxDamageInput =
                                document.getElementById("log-max-damage-input")
                                    .shorthandIntegerInput()
                            val resultTypeInput =
                                document.getElementById("log-result-type")
                                    .singleSelect(false)
